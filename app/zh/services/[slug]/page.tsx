...
const SERVICE_ZH: Record<string, { title: string; description: string; includes: string[]; faqs: { q: string; a: string }[] }> = {
  "event-shoots": { title: "迪拜活动摄影服务", description: "为迪拜及阿联酋的各类活动提供专业摄影服务——会议、企业活动、产品发布、婚礼及私人庆典。我们的团队确保电影级画质，并在48小时内交付素材。\n\n服务覆盖阿联酋全部七个酋长国，持有GCAA无人机航拍许可证。", includes: ["摄影师+摄像师团队","4至10小时拍摄","300张以上精修照片","专业精华集锦视频","48小时内交付","GCAA认证无人机航拍"], faqs: [{ q: "迪拜活动摄影费用是多少？", a: "活动摄影从半天3,000迪拉姆起，大型活动可达20,000迪拉姆以上。2小时内免费报价。" },{ q: "你们拍摄哪些类型的活动？", a: "会议、企业活动、产品发布、展览、婚礼及各类私人庆典均可承接。" },{ q: "素材多久能交付？", a: "活动照片和视频在拍摄结束后48小时内交付。" },{ q: "迪拜以外的地区也服务吗？", a: "是的，我们覆盖阿联酋全部七个酋长国——阿布扎比、沙迦、阿治曼、哈伊马角、富查伊拉和乌姆盖万。" }] },
