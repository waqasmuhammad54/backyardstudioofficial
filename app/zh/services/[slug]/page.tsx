...
const SERVICE_ZH: Record<string, { title: string; description: string; includes: string[]; faqs: { q: string; a: string }[] }> = {
 "event-shoots": { title: "迪拜活动摄影服务", description: "为迪拜及阿联酋的各类活动提供专业摄影服务——会议、企业活动、产品发布、婚礼及私人庆典。我们的团队确保电影级画质，并在48小时内交付素材。\n\n服务覆盖阿联酋全部七个酋长国，航拍在合法许可下执行。", includes: ["摄影师+摄像师团队","4至10小时拍摄","300张以上精修照片","专业精华集锦视频","48小时内交付","无人机航拍"], faqs: [{ q: "迪拜活动摄影费用是多少？", a: "活动摄影从半天3,000迪拉姆起，大型活动可达20,000迪拉姆以上。2小时内免费报价。" },{ q: "你们拍摄哪些类型的活动？", a: "会议、企业活动、产品发布、展览、婚礼及各类私人庆典均可承接。" },{ q: "素材多久能交付？", a: "活动照片和视频在拍摄结束后48小时内交付。" },{ q: "迪拜以外的地区也服务吗？", a: "是的，我们覆盖阿联酋全部七个酋长国——阿布扎比、沙迦、阿治曼、哈伊马角、富查伊拉和乌姆盖万。" }] },
 ...
 "aerial-drone": { title: "无人机航拍服务", description: "阿联酋全境合法授权无人机航拍——所有商业航拍均在合法许可下执行。为房地产、活动和品牌广告提供4K电影级航拍画面。\n\n所有拍摄均已投保并获得阿联酋相关部门授权。", includes: ["无人机飞手","官方许可证协调办理","4K+慢动作航拍","专业电影级调色","RAW原始文件随附","24小时内交付"], faqs: [{ q: "迪拜商业航拍需要许可证吗？", a: "需要，商业航拍须持有飞行许可证。我们负责办理所有审批手续。" },{ q: "哪些地方禁止航拍？", a: "机场附近、政府设施及限制区域禁止航拍。我们事先对每个拍摄地点进行审查。" },{ q: "迪拜无人机航拍费用是多少？", a: "附加至现有拍摄项目从2,000迪拉姆起，单独无人机拍摄日4,500迪拉姆，多地点广告活动从12,000迪拉姆起。" },{ q: "使用什么设备？", a: "大疆Mavic 3 Pro和Enterprise，支持60fps 4K拍摄，配备完整调色流程。" }] },
 ...
 "automotive": { title: "迪拜汽车摄影服务", description: "专业汽车摄影，以电影风格呈现美学与设计之美——适用于汽车经销商、杂志和广告活动，以迪拜标志场景为背景。\n\n丰富的豪华车型、国际品牌和汽车运动拍摄经验。", includes: ["内饰与外观拍摄","迪拜标志场景背景","无人机航拍","高质量精修照片","电影级汽车视频","48小时内交付"], faqs: [{ q: "迪拜最佳汽车拍摄场地是哪里？", a: "推荐迪拉溪、工业区、市中心Downtown以及迪拜风景优美的立交桥周边。" },{ q: "拍摄豪华车和跑车吗？", a: "拍摄，有丰富的法拉利、兰博基尼、劳斯莱斯及商用车拍摄经验。" },{ q: "汽车拍摄需要航拍吗？", a: "不是必须的，但航拍能增添震撼视角，额外费用从2,000迪拉姆起。" },{ q: "迪拜汽车拍摄费用是多少？", a: "半天拍摄从3,000迪拉姆起，完整汽车广告视频可达25,000迪拉姆以上。" }] },
 "real-estate": { title: "迪拜房产摄影服务", description: "为迪拜公寓、办公室、别墅和开发项目提供专业房产摄影——吸引买家和租户的高质量照片与视频。\n\n无人机航拍、虚拟参观视频和完整项目影像呈现。", includes: ["室内外全方位拍摄","无人机航拍","专业后期修图","虚拟参观视频","24小时内交付","完整商业使用权"], faqs: [{ q: "为什么房产销售需要专业摄影？", a: "有专业照片的房产在平台上的销售速度快32%，浏览量高出60%。" },{ q: "拍摄在建项目吗？", a: "拍摄，我们承接各阶段施工进度记录和施工进度视频制作。" },{ q: "迪拜房产摄影费用是多少？", a: "小型公寓从2,000迪拉姆起，别墅从5,000迪拉姆起，大型项目从10,000迪拉姆起。" },{ q: "提供夜间房产摄影吗？", a: "提供，夜间和黄昏拍摄包含在我们的综合套餐中。" }] },
 ...
 "car-commercials": { title: "迪拜与阿联酋汽车广告制作", description: "阿联酋最高制作水准的汽车广告——电影级拍摄，为国际汽车集团呈现设计美学与驾驶动感。\n\n涵盖豪华车、跑车、家用车及商用车广告拍摄经验。", includes: ["汽车广告专业导演","迪拜赛道及标志场景拍摄","无人机航拍","剪辑与专业特效","原创或版权配乐","电视及数字平台多版本"], faqs: [{ q: "迪拜汽车广告费用是多少？", a: "数字视频从25,000迪拉姆起，完整电视制作可达150,000迪拉姆以上。" },{ q: "可以在迪拜主要道路上拍摄吗？", a: "我们与相关部门协调，获取道路和公共场所拍摄许可。" },{ q: "提供拍摄专业驾驶员吗？", a: "提供，我们与经验丰富的驾驶员合作，配合拍摄最佳特技镜头。" },{ q: "完整汽车广告活动需要多长时间？", a: "从简报到交付需要3至5周。" }] },
