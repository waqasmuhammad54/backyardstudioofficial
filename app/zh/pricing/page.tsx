...
export const metadata: Metadata = {
  ...
  description: "迪拜制作价格2026：婚礼摄影从1,799迪拉姆起，DVC广告从15,000迪拉姆起，无人机航拍从2,000迪拉姆起，社交媒体内容从2,500迪拉姆起。GCAA认证。",
  keywords: ["迪拜婚礼摄影价格", "阿联酋视频制作费用", "迪拜无人机航拍价格", "迪拜社交媒体内容价格", "迪拜制作套餐2026"],
  alternates: {
  ...
  openGraph: {
    ...
    description: "透明定价：婚礼从1,799 AED起，DVC从15,000 AED起，无人机从2,000 AED起。2小时内免费报价。",
...
const PACKAGES_ZH = [
  {
    category: "婚礼摄影与摄像",
    anchor: "wedding",
    intro: "迪拜最受欢迎的婚礼制作套餐——从实惠摄影到多日制作均有覆盖。每个套餐48小时交付保障。",
    plans: [
      { name: "基础版", price: "1,799 AED", label: "经济摄影", desc: "适合小型仪式和公证婚礼的专业摄影，价格实惠。", includes: ["1名专业摄影师", "3小时拍摄", "100+精修照片", "在线相册交付", "48小时内交付", "可添加摄像服务1,200 AED起"], featured: false },
      { name: "银版", price: "3,500 AED", label: "半天拍摄", desc: "适合民政婚礼、尼卡仪式或小型庆典。", includes: ["1名摄影师+1名摄像师", "4小时拍摄", "150–200张精修照片", "3分钟精华视频", "在线相册", "48小时内交付"], featured: false },
      { name: "金版", price: "8,500 AED", label: "全天婚礼", desc: "最受欢迎的套餐——从婚礼筹备到宴会全程记录。", includes: ["2名摄影师+2名摄像师", "10小时拍摄", "400–600张精修照片", "电影感精华影片（5–8分钟）", "GCAA认证无人机航拍", "当日快剪短片", "48小时完整交付", "婚前咨询"], featured: true },
      { name: "铂金版", price: "18,000+ AED", label: "高端多日制作", desc: "印度婚礼、多日活动及阿联酋各地目的地婚礼。", includes: ["多日全程拍摄", "3+名摄影师及摄像师", "1,000+张精修照片集", "完整婚礼影片", "当日社交媒体短视频", "所有场地无人机航拍", "婚前写真拍摄", "48小时交付保障"], featured: false },
    ],
  },
  {
    category: "社交媒体内容创作",
  ...
  {
    category: "无人机航拍（GCAA认证）",
    anchor: "drone",
    intro: "覆盖阿联酋全境的合法持证无人机航拍服务。所有拍摄均已投保并与相关部门协调。",
    plans: [
      { name: "附加服务", price: "2,000 AED", label: "添加至任意拍摄", desc: "为任何现有制作预约添加GCAA认证无人机航拍。", includes: ["2小时航拍", "4K航拍素材", "调色后航拍精剪", "包含RAW原始文件", "当日预览"], featured: false },
      { name: "独立拍摄", price: "4,500 AED", label: "专属无人机日", desc: "完整无人机拍摄日——适用于房地产、活动与品牌营销活动。", includes: ["全天航拍", "4K电影级素材", "协调全部阿联酋拍摄许可", "调色后精华剪辑", "4K RAW文件交付", "24小时内交付"], featured: true },
      { name: "项目拍摄", price: "12,000+ AED", label: "多地点航拍", desc: "适用于房地产开发商、旅游业与影视的多地点无人机营销活动。", includes: ["多日航拍计划", "阿联酋多个拍摄地点", "完整许可协调", "4K+慢动作素材", "调色后可交付成品", "与地面摄制组协同"], featured: false },
    ],
  },
];

const FAQS_ZH = [
  { q: "迪拜婚礼摄影师收费多少？", a: "迪拜婚礼摄影价格从Backyard Studio Official基础套餐的1,799 AED到含无人机、视频、婚前写真和当日精华的完整多日印度婚礼25,000+ AED不等。我们最受欢迎的全天婚礼套餐（金版）售价8,500 AED，包含2名摄影师、2名摄像师、无人机航拍及48小时交付。" },
  ...
  { q: "迪拜无人机航拍收费多少？", a: "迪拜GCAA认证无人机航拍从现有拍摄附加2,000 AED起，独立无人机拍摄日4,500 AED，多地点无人机营销活动12,000+ AED。我们的所有无人机拍摄均包含完整GCAA许可证、保险及调色后可交付成品。" },
