        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              ...
              { factor: "التصوير الجوي بالطائرات المسيّرة", detail: "يتطلب ترخيص GCAA التجارية — وليس مجرد تصريح ترفيهي. التصوير الجوي غير المرخص يعرضك لغرامات تصل إلى AED 50,000." },
