...
export const metadata: Metadata = {
  title: "أسعار إنتاج الفيديو الشركاتي في دبي 2026 — دليل التكاليف الشامل",
  description:
    "كم تكلفة إنتاج فيديو شركاتي في دبي؟ أسعار أفلام العلامات التجارية والإعلانات الرقمية DVCs والمحتوى الشركاتي في الإمارات. باكيارد ستوديو — عرض سعر مجاني خلال ساعتين.",
  alternates: {
