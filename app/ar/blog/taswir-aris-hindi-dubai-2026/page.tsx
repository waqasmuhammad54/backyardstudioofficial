  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "نعم — التصوير الجوي يُنفَّذ بترخيص GCAA للتصوير الجوي التجاري في الإمارات. تصوير البارات من الجو يضيف بُعداً سينمائياً رائعاً لموكب العريس، ونحن من أكثر الفرق خبرةً في هذا الأسلوب بدبي.",
        },
      },
      {
        "@type": "Question",
