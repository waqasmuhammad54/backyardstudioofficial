  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "نعم — فريقنا يحمل رخصة GCAA للتصوير الجوي التجاري في الإمارات. تصوير البارات من الجو يضيف بُعداً سينمائياً رائعاً لموكب العريس، ونحن من أكثر الفرق خبرةً في هذا الأسلوب بدبي.",
        },
      },
      {
        "@type": "Question",
