  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "نعم، التصوير الجوي يُنفَّذ بترخيص GCAA من هيئة الطيران المدني الإماراتية لتشغيل الطائرات المسيّرة. اللقطات الجوية لقاعات الأفراح والفلل تُضيف بُعداً استثنائياً، مع مراعاة الأعراف والخصوصية الكاملة.",
        },
      },
      {
        "@type": "Question",
