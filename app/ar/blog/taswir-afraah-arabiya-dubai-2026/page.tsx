  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
 text: "نعم حيثما يُسمح بذلك. التصوير الجوي يُنفَّذوننسّق مع إدارة الفندق أو القاعة مسبقاً لضمان الحصول على الإذن اللازم. المشاهد الجوية تضيف فخامة استثنائية للذكريات.",
        },
      },
    ],
  };
