...
export const metadata: Metadata = {
  ...
  description:
    "مصوّر رياضي محترف في دبي. تصوير كرة القدم، الكريكيت، التنس، اللياقة، الماراثون والفنون القتالية. رخصة GCAA. من AED 1,500.",
  alternates: {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "نعم — فريقنا يحمل رخصة GCAA للتصوير التجاري بالطائرة المسيّرة في الإمارات. تصوير الماراثون والملاعب المفتوحة والفعاليات الشاطئية من الجو يضيف بُعداً استثنائياً.",
        },
      },
      {
        "@type": "Question",
