  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
 text: "نعم — التصوير الجوي يُنفَّذللتصوير التجاري بالطائرة المسيّرة في الإمارات. تصوير الماراثون والملاعب المفتوحة والفعاليات الشاطئية من الجو يضيف بُعداً استثنائياً.",
        },
      },
      {
        "@type": "Question",
