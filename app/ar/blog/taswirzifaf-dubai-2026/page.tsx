  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "نعم، التصوير الجوي يُنفَّذ بترخيص GCAA للتصوير الجوي بالطائرات المسيّرة في جميع إمارات الدولة. يمكن تصوير قصر الأفراح أو فيلا الحفل من الجو لإضافة بُعد استثنائي لألبوم الذكريات.",
        },
      },
      {
        "@type": "Question",
  ...
  return (
    <>
      ...
      >
        ...
        <p style={{ marginBottom: "2.5rem" }}>
          التصوير الجوي يُنفَّذ بترخيص GCAA (الهيئة العامة للطيران المدني) لتشغيل الطائرات المسيّرة في جميع أنحاء
