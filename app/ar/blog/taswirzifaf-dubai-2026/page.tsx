...
export const metadata: Metadata = {
  title: "تصوير الزفاف في دبي 2026 | باكيارد ستوديو",
  description:
    "كيف تختار أفضل مصور أعراس في دبي؟ أسعار الزفاف، الفرق بين الفيديو السينمائي والتقليدي، وكيف يعمل فريق باكيارد ستوديو في يومك الأهم.",
  alternates: {
...
export default function WeddingPhotographyArPage() {
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
 text: "نعم، التصوير الجوي يُنفَّذللتصوير الجوي بالطائرات المسيّرة في جميع إمارات الدولة. يمكن تصوير قصر الأفراح أو فيلا الحفل من الجو لإضافة بُعد استثنائي لألبوم الذكريات.",
        },
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        ...
        <div style={{ width: "100%", height: "420px", borderRadius: "4px", marginBottom: "3rem", overflow: "hidden" }}>
          <img src="https://images.unsplash.com/photo-1519741497674-611481863552?w=1200&q=80" alt="Taswirzifaf Dubai 2026" style={{ width: "100%", height: "420px", objectFit: "cover", borderRadius: "4px", marginBottom: "3rem", display: "block" }} loading="lazy" />
        </div>
        ...
        <p style={{ marginBottom: "2.5rem" }}>
 التصوير الجوي يُنفَّذ(الهيئة العامة للطيران المدني) لتشغيل الطائرات المسيّرة في جميع أنحاء
 ...
 a: "نعم، فريقنا مرخّص ويمكنه تصوير حفلكم جوياً في أي مكان ضمن الإمارات.",
            },
            {
