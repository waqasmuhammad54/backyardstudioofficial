...
export const metadata: Metadata = {
  title: "تصوير الفعاليات في دبي 2026 — دليل شامل لتوثيق المؤتمرات والحفلات والمعارض",
  description:
    "احجز أفضل مصور فعاليات في دبي. تغطية احترافية للمؤتمرات والحفلات والمعارض والفعاليات الشركاتية في الإمارات. باكيارد ستوديو — 2,400+ مشروع، رد في ساعتين.",
  alternates: {
