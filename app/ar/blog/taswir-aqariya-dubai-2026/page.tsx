  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "نعم — التصوير الجوي يُنفَّذ بترخيص GCAA كامل للتصوير الجوي التجاري. التصوير الجوي يُبرز الموقع والمحيط والمساحات الخارجية بشكل لا يمكن تحقيقه من الأرض — ضروري للفلل والمجمعات السكنية الكبيرة.",
        },
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      <article style={{ fontFamily: "Inter, sans-serif", maxWidth: "860px", margin: "0 auto", padding: "4rem 2rem", color: "var(--cream)", lineHeight: "1.85" }}>
        ...
        <div style={{ width: "100%", height: "420px", borderRadius: "4px", marginBottom: "3rem", overflow: "hidden", position: "relative" }}>
          <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1200&q=80" alt="Real Estate Photography Dubai 2026" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} loading="lazy" />
        </div>
