  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
 text: "نعم — التصوير الجوي يُنفَّذ للتصوير الجوي التجاري. التصوير الجوي يُبرز الموقع والمحيط والمساحات الخارجية بشكل لا يمكن تحقيقه من الأرض — ضروري للفلل والمجمعات السكنية الكبيرة.",
        },
      },
      {
        "@type": "Question",
