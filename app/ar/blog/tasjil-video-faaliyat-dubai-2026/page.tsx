...
export const metadata: Metadata = {
  ...
  description:
 "تصوير فيديو الفعاليات في دبي من 3,500 درهم. هايلايت في نفس اليوم، تصوير متعدد الكاميرات، لقطات جوية. مؤتمرات، حفلات غالا، فعاليات الماركات.",
  alternates: {
...
export default function EventVideographyArPage() {
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
 text: "نعم، فريقنا مرخّص ويمكن إضافة لقطات جوية للفعاليات الخارجية والمواقع التي تسمح بالطيران. اللقطات الجوية تُضيف بُعداً بصرياً استثنائياً لفيديو الفعالية.",
        },
      },
    ],
  };
    ...
    <>
      ...
      <article dir="rtl" lang="ar" style={{ fontFamily: "Cairo, sans-serif", maxWidth: "860px", margin: "0 auto", padding: "4rem 2rem", color: "var(--cream)", lineHeight: "1.9" }}>
        ...
        <div style={{ width: "100%", height: "420px", borderRadius: "4px", marginBottom: "3rem", overflow: "hidden", position: "relative" }}>
          <img src="https://images.unsplash.com/photo-1485846234645-a62644f84728?w=1200&q=80" alt="Event Videography Dubai 2026" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} loading="lazy" />
        </div>
 ...
 { q: "هل تتضمن الخدمة لقطات درون؟", a: "نعم، الدرون خيار إضافي متاح للفعاليات الخارجية مع الترخيص اللازم." },
