...
export const metadata: Metadata = {
 ...
 description: "خدمات إنتاج متكاملة في دبي والإمارات: تصوير فيديو مؤسسي من 15,000 درهم، تصوير الأعراس من 3,500 درهم، الفعاليات، الطائرات المسيّرة، محتوى رقمي. عرض سعر مجاني.",
  ...
  openGraph: {
    title: "خدمات التصوير والإنتاج في دبي والإمارات | باكيارد ستوديو أوفيشيال",
 description: "خدمات إنتاج متكاملة: فيديو مؤسسي، أعراس، فعاليات، طائرات مسيّرة، محتوى رقمي. أسعار شفافة وعرض مجاني.",
 ...
 description: "فيديو مؤسسي، أعراس، فعاليات، طائرات مسيّرة. عرض مجاني خلال ساعتين.",
    images: ["/og-image.jpg"],
  },
};
...
const SERVICES = [
  ...
  {
    icon: "🚁",
 title: "تصوير بالطائرة المسيّرة ",
 desc: "تصوير جوي بتصريح — للعقارات، الفعاليات، والإعلانات في دبي وجميع الإمارات السبع.",
...
const SERVICES_FAQS = [
 { q: "ما هي خدمات الإنتاج التي تقدمها باكيارد ستوديو في دبي؟", a: "نقدم طيفاً كاملاً من خدمات الإنتاج: فيديو مؤسسي، تصوير الأعراس والفعاليات، تصوير جوي ب الترخيص اللازم، محتوى وسائل التواصل الاجتماعي، تصوير المنتجات والأزياء، والعقارات." },
 ...
 { q: "هل التصوير الجوي متاحللتصوير بالطائرات المسيّرة؟", a: "نعم. التصوير الجوي يُنفَّذ (الهيئة العامة للطيران المدني) للتصوير الجوي التجاري في جميع إمارات الدولة. تبدأ أسعار التصوير الجوي من 2,000 درهم." },
...
export default function ArServicesPage() {
 ...
 a: "نعمل بكاميرات Sony FX سيريز وBlackmagic Cinema للتصوير الاحترافي، ومجموعة متكاملة من الإضاءة Aputure وAPNG والميكروفونات اللاسلكية Sennheiser. للتصوير الجوي، نستخدم طائرات DJI Inspire وMavic سيريز ب الترخيص اللازم. نُعدِّل المعدات بحسب متطلبات كل مشروع.",
              },
              {
                q: "هل تتعاملون مع مشاريع حكومية في دبي والإمارات؟",
 a: "نعم. سبق لنا تقديم خدمات تصوير لجهات حكومية ومؤسسات شبه حكومية في الإمارات. نلتزم بالإجراءات والتراخيص المطلوبة لمشاريع القطاع العام، بما فيها تصاريح التصوير في المواقع الحكومية وتصاريح الطيران في المناطق الخاضعة لقيود.",
              },
              {
