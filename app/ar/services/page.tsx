...
const SERVICES_FAQS = [
  ...
  { q: "هل التصوير الجوي متاح بترخيص GCAA للتصوير بالطائرات المسيّرة؟", a: "نعم. التصوير الجوي يُنفَّذ بترخيص GCAA المعتمدة (الهيئة العامة للطيران المدني) للتصوير الجوي التجاري في جميع إمارات الدولة. تبدأ أسعار التصوير الجوي من 2,000 درهم." },
