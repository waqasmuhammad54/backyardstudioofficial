...
export const metadata: Metadata = {
  ...
  description: "أسعار الإنتاج في دبي 2026: تصوير أعراس يبدأ من 1,799 درهم، إعلانات تجارية من 15,000 درهم، تصوير جوي من 2,000 درهم، محتوى سوشيال ميديا من 2,500 درهم. رخصة GCAA.",
  ...
  openGraph: {
    ...
    description: "أسعار شفافة: أعراس من 1,799 درهم، إعلانات تجارية من 15,000 درهم، تصوير جوي من 2,000 درهم. عرض سعر مجاني خلال ساعتين.",
...
const PACKAGES_AR = [
  {
    ...
    anchor: "wedding",
    intro: "الباقات الأكثر طلباً في دبي لتصوير الأعراس — من التصوير المعقول حتى الإنتاجات متعددة الأيام. تسليم خلال 48 ساعة في كل الباقات.",
    plans: [
      { name: "الأساسية", price: "1,799 درهم", label: "تصوير اقتصادي", desc: "تصوير احترافي بأسعار مناسبة للمناسبات الصغيرة وحفلات الزفاف المدنية.", includes: ["مصوّر واحد محترف", "3 ساعات تغطية", "100+ صورة معدّلة", "معرض تسليم إلكتروني", "تسليم خلال 48 ساعة", "إضافة فيديو من 1,200 درهم"], featured: false },
      { name: "الفضية", price: "3,500 درهم", label: "تغطية نصف يوم", desc: "مثالية للمناسبات المدنية والعقود الدينية والاحتفالات الصغيرة.", includes: ["مصوّر + مصوّر فيديو", "4 ساعات تغطية", "150–200 صورة معدّلة", "فيديو تسليط ضوء 3 دقائق", "معرض إلكتروني", "تسليم خلال 48 ساعة"], featured: false },
      { name: "الذهبية", price: "8,500 درهم", label: "زفاف يوم كامل", desc: "الباقة الأكثر شعبية — تغطية كاملة ليوم الزفاف من التحضيرات حتى الاستقبال.", includes: ["2 مصوّر + 2 مصوّر فيديو", "10 ساعات تغطية", "400–600 صورة معدّلة", "فيلم سينمائي (5–8 د.)", "تصوير جوي بطائرة مسيّرة (GCAA)", "مقطع تشويقي نفس اليوم", "تسليم كامل خلال 48 ساعة", "جلسة استشارية قبل الزفاف"], featured: true },
      { name: "البلاتينية", price: "18,000+ درهم", label: "متعدد الأيام الفاخر", desc: "الأعراس الهندية والمناسبات متعددة الأيام عبر الإمارات.", includes: ["تغطية متعددة الأيام", "3+ مصوّرين وعوامل فيديو", "1,000+ صورة معدّلة", "فيلم زفاف كامل", "ريلز سوشيال ميديا نفس اليوم", "طائرة مسيّرة في جميع المواقع", "جلسة قبل الزفاف", "ضمان تسليم 48 ساعة"], featured: false },
    ],
  },
  {
...
const FAQS_AR = [
  { q: "كم تبلغ أسعار تصوير الأعراس في دبي؟", a: "تتراوح أسعار تصوير الأعراس في دبي من 1,799 درهم للباقة الأساسية الاقتصادية وحتى 25,000+ درهم للأعراس الهندية متعددة الأيام مع طائرة مسيّرة وفيديو وجلسة ما قبل الزفاف. الباقة الأكثر طلباً (الذهبية) بسعر 8,500 درهم تشمل مصوّرَين ومصوّرَي فيديو وطائرة مسيّرة وتسليم خلال 48 ساعة." },
