...
export const metadata: Metadata = {
  ...
  description: "أسعار الإنتاج في دبي 2026: تصوير أعراس يبدأ من 7,500 درهم، إعلانات تجارية من 15,000 درهم، تغطية فعاليات من 3,000 درهم، محتوى سوشيال ميديا من 2,500 درهم. عرض سعر خلال ساعتين.",
  keywords: ["أسعار تصوير أعراس دبي", "تكلفة الإنتاج التجاري الإمارات", "أسعار تغطية الفعاليات دبي", "أسعار محتوى السوشيال ميديا دبي", "باقات الإنتاج دبي 2026"],
  alternates: {
  ...
  openGraph: {
    ...
    description: "أسعار شفافة: أعراس من 7,500 درهم، إعلانات تجارية من 15,000 درهم، فعاليات من 3,000 درهم. عرض سعر مجاني خلال ساعتين.",
...
const FAQS_AR = [
 ...
 { q: "ما تكلفة التصوير الجوي بطائرة مسيّرة في دبي؟", a: "التصوير الجوي المرخّص بـ في دبي يبدأ من 2,000 درهم إضافة لأي جلسة، و4,500 درهم ليوم طائرة مسيّرة كامل، و12,000+ درهم للحملات متعددة المواقع. جميع جلساتنا تشمل تصاريح الكاملة والتأمين والمواد الملوّنة." },
