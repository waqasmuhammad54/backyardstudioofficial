...
const LOCATIONS_FAQS = [
 ...
 { q: "ما خدمات التصوير المتاحة في جميع أنحاء الإمارات؟", a: "نقدم كامل خدماتنا الإنتاجية في جميع الإمارات: تصوير الفعاليات، الأعراس، إعلانات DVC، محتوى إنستغرام والريلز، أفلام مؤسسية، تصوير جوي بطائرة مسيّرة ب الترخيص اللازم، فيديوهات الشهادات والإعلانات التجارية." },
];
