...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "شركة الإنتاج الإبداعي الرائدة في دبي والإمارات. أكثر من 2,400 مشروع. رخصة GCAA للطائرات المسيّرة. عرض سعر مجاني خلال ساعتين.",
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontFamily: "Cairo, sans-serif", color: "rgba(245,240,225,0.7)", lineHeight: 1.8, marginBottom: "1.5rem", fontSize: "0.95rem" }}>
              يترأس فريق ما بعد الإنتاج <strong style={{ color: "var(--cream)" }}>سيد مظهر زيدي</strong>، المخرج السينمائي والمصور الوثائقي بخبرة تتجاوز 20 عاماً. نمتلك رخصة GCAA للتصوير الجوي التجاري ونعمل في جميع إمارات الدولة.
            </p>
