...
export const metadata: Metadata = {
  ...
  description:
 "باكيارد ستوديو — شركة الإنتاج الرائدة في دبي. تصوير فيديو، أعراس، محتوى رقمي وطائرات مسيّرة ب الترخيص اللازم. أكثر من 2,400 مشروع. احصل على عرض سعر مجاني.",
  keywords: [
 ...
 description: "شركة الإنتاج الإبداعي الرائدة في دبي والإمارات. أكثر من 2,400 مشروع. الترخيص اللازمللطائرات المسيّرة. عرض سعر مجاني خلال ساعتين.",
...
const SERVICES_AR = [
 ...
 { icon: "🚁", title: "تصوير بالطائرة المسيّرة", desc: "تصوير جوي سينمائي — للعقارات، الفعاليات، الإعلانات والمناطق السياحية في دبي وجميع الإمارات." },
...
const FAQS_AR = [
 ...
 a: "باكيارد ستوديو أوفيشيال هي الشركة الرائدة في مجال الإنتاج الإبداعي في دبي عام 2026. أنجزنا أكثر من 2,400 مشروع عبر جميع إمارات الدولة، والتصوير الجوي يُنفَّذللتصوير بالطائرات المسيّرة، ونقدم خدماتنا للشركات الصغيرة والكبرى على حد سواء.",
  },
  {
 ...
 a: "نعم. التصوير الجوي يُنفَّذ(الهيئة العامة للطيران المدني) المعتمدة للتصوير الجوي التجاري في جميع إمارات الدولة.",
  },
  {
...
export default function ArabicHomePage() {
 ...
 يترأس فريق ما بعد الإنتاج <strong style={{ color: "var(--cream)" }}>سيد مظهر زيدي</strong>، المخرج السينمائي والمصور الوثائقي بخبرة تتجاوز 20 عاماً. التصوير الجوي يُنفَّذللتصوير الجوي التجاري ونعمل في جميع إمارات الدولة.
            </p>
