...
export const metadata: Metadata = {
 ...
 description: "تعرّف على استوديو باكيارد أوفيشيال — شركة الإنتاج الإبداعي الرائدة في دبي. تأسست عام 2019 على يد فهد إقبال بط وسيد مظهر زيدي. أكثر من 2,400 مشروع وخدمة تصوير جوي.",
  ...
  openGraph: {
    title: "عن باكيارد ستوديو أوفيشيال | فهد إقبال بط وسيد مظهر زيدي — دبي",
 description: "شركة الإنتاج الإبداعي الرائدة في دبي. تأسست 2019. أكثر من 2,400 مشروع، تصوير جوي، فريق بخبرة 20+ عاماً.",
 ...
 description: "تأسست 2019 على يد فهد إقبال بط. أكثر من 2,400 مشروع. خدمة تصوير جوي.",
    images: ["/og-image.jpg"],
  },
};
...
const MILESTONES_AR = [
 ...
 { year: "2024", event: "إضافة التصوير الجوي — خدمة في جميع الإمارات" },
