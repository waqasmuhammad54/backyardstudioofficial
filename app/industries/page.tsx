...
export const metadata: Metadata = {
  title: "Industry Video & Photography Production Services Dubai UAE | Backyard Studio Official",
  description: "Specialised production for hospitality, real estate, fashion, food & beverage, and corporate sectors across UAE. Dubai's leading industry-specific content studio.",
  keywords: [
