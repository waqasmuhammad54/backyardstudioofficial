 ...
 От 2 500 AED: фото и видео для квартир, вилл и проектов застройщиков. Аэросъёмка. Реальные цены и что входит в каждый пакет — опыт Backyard Studio из 2 400+ проектов.
      ...
      <article style={{ padding: "3rem 2rem 5rem", background: "#0a0a0a" }}>
        <div style={{ maxWidth: "780px", margin: "0 auto" }}>
          ...
          <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1400&q=80" alt="Semka Nedvizhimosti Dubai 2026" style={{ width: "100%", height: "420px", objectFit: "cover", borderRadius: "4px", marginBottom: "3rem", display: "block" }} loading="lazy" />
          {SECTIONS.map((s, i) => (
