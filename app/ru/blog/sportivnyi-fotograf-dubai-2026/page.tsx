...
export const metadata: Metadata = {
  ...
  description:
    "Профессиональный спортивный фотограф в Дубае. Съёмка футбола, крикета, тенниса, фитнеса, марафонов и боевых искусств.. Аэросъёмка, одобренная GCAA. От AED 1 500.",
  alternates: {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Да — аэросъёмка выполняется по лицензии GCAA для коммерческих полётов в ОАЭ. Дроновая съёмка марафонов, пляжных турниров и открытых стадионов добавляет масштаб и кинематографичность. Уточняйте разрешения по конкретным объектам заранее.",
        },
      },
      {
        "@type": "Question",
