  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
 text: "Да — аэросъёмка выполняется по действующей лицензии для коммерческих полётов в ОАЭ. Дроновая съёмка марафонов, пляжных турниров и открытых стадионов добавляет масштаб и кинематографичность. Уточняйте разрешения по конкретным объектам заранее.",
        },
      },
      {
        "@type": "Question",
