  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Да, наша команда имеет коммерческую лицензию GCAA на управление дронами по всей территории ОАЭ, включая Абу-Даби. Аэросъёмка Emirates Palace или пляжей Yas Island добавляет эффектный визуальный план, недостижимый с земли. Все полёты полностью легальны и застрахованы.",
        },
      },
    ],
  };
        ...
        <section>
          ...
          <div className="space-y-6">
            {[
              ...
              { q: "Можно ли снимать дрон в Emirates Palace?", a: "Да, с нашей GCAA-лицензией и предварительным согласованием с менеджментом площадки. Мы берём на себя всю координацию с отелем — вам не нужно этим заниматься самостоятельно." },
            ].map((faq, i) => (
