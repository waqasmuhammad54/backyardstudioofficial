...
export default function WeddingPhotographerAbuDhabiRuPage() {
 ...
 text: "Свадебная съёмка в Абу-Даби начинается от AED 4,000 за базовый пакет с одним видеографом на полный день и кинематографическим клипом 3–5 минут. Премиум-пакеты с двумя видеографами, дроном ( лицензия), полнометражным фильмом и экспресс-монтажем стоят от AED 9,000 до AED 18,000. Съёмка для роскошных площадок — Emirates Palace, Qasr Al Watan — от AED 15,000.",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
 text: "Да, аэросъёмка выполняется по коммерческой лицензии на управление дронами по всей территории ОАЭ, включая Абу-Даби. Аэросъёмка Emirates Palace или пляжей Yas Island добавляет эффектный визуальный план, недостижимый с земли. Все полёты полностью легальны и застрахованы.",
        },
      },
    ],
  };
 ...
 { name: "Популярный пакет", price: "от AED 9,000 – 12,000", includes: ["2 видеографа, полный день", " дрон (аэросъёмка)", "Клип 6–8 минут + запись церемонии", "Тизер в течение 48 часов", "USB-бокс в подарок"] },
 ...
 { q: "Можно ли снимать дрон в Emirates Palace?", a: "Да, с действующей лицензия на полёт и предварительным согласованием с менеджментом площадки. Мы берём на себя всю координацию с отелем — вам не нужно этим заниматься самостоятельно." },
            ].map((faq, i) => (
