  ...
  return (
    <>
      ...
      <article style={{ fontFamily: "Inter, sans-serif", maxWidth: "860px", margin: "0 auto", padding: "4rem 2rem", color: "var(--cream)", lineHeight: "1.85" }}>
        ...
        <h2 style={{ fontSize: "1.5rem", fontWeight: 700, color: "var(--gold)", marginBottom: "1rem", marginTop: "3rem" }}>
          Как сделать детскую съёмку комфортной?
        </h2>
        <p style={{ marginBottom: "1.2rem" }}>
          Дети в возрасте от 6 месяцев до 5 лет требуют особого подхода. Наши фотографы 
          специализируются на работе с детьми: они умеют создавать непринуждённую атмосферу, 
          используют игровые методы для получения натуральных эмоций и работают быстро, 
          пока внимание ребёнка сосредоточено. Мы никогда не торопим ни детей, ни родителей 
          — хороший кадр возникает тогда, когда ребёнок расслаблен и в хорошем настроении.
        </p>
        <p style={{ marginBottom: "1.2rem" }}>
          Практические советы для родителей: планируйте съёмку на время после сна и после 
          еды, возьмите любимую игрушку или книгу, оденьте ребёнка в однотонную одежду 
          без ярких принтов. Одежду лучше надеть на месте — так она будет свежей и без 
          складок от дороги.
        </p>
        <h2 style={{ fontSize: "1.5rem", fontWeight: 700, color: "var(--gold)", marginBottom: "1rem", marginTop: "3rem" }}>
          Какие форматы детской съёмки мы предлагаем?
        </h2>
        <p style={{ marginBottom: "1.2rem" }}>
          Мы предлагаем три формата: студийная съёмка на нейтральном фоне (классическая 
          и элегантная), семейная съёмка на природе или в любимом месте (естественная и 
          тёплая), и тематические детские сессии — с декорациями, реквизитом и продуманным 
          образом для особых случаев (день рождения, первый год жизни, поступление в школу). 
          Все три формата доступны как отдельные, так и в комбинированном виде.
        </p>
