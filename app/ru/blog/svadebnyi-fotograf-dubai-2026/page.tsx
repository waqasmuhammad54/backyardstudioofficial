...
export default function WeddingPhotographerRuPage() {
    ...
    <>
      ...
      >
        ...
        <div style={{ width: "100%", height: "420px", borderRadius: "4px", marginBottom: "3rem", overflow: "hidden" }}>
          <img src="https://images.unsplash.com/photo-1519741497674-611481863552?w=1200&q=80" alt="Svadebnyi Fotograf Dubai 2026" style={{ width: "100%", height: "420px", objectFit: "cover", borderRadius: "4px", marginBottom: "3rem", display: "block" }} loading="lazy" />
        </div>
 ...
 лицензирована и знает, в каких зонах Дубая полёты разрешены без дополнительных
 ...
 "Лицензирован ли ваш дрон для съёмки в ОАЭ?",
