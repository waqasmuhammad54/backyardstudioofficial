  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Да, аэросъёмка выполняется по коммерческой лицензии GCAA для полётов по всему ОАЭ. Аэросъёмка резко повышает привлекательность листинга — особенно для вилл, пентхаусов и объектов с видом. Все полёты легальны, застрахованы и согласованы с соответствующими органами.",
        },
      },
      {
        "@type": "Question",
        ...
        <section>
          ...
          <div className="space-y-6">
            {[
              ...
              { q: "Можно ли снять дрон в жилых комплексах Дубая?", a: "В большинстве случаев — да, при наличии действующей GCAA-лицензии на полёт и согласования с управляющей компанией комплекса. Мы берём на себя всю организацию. В некоторых закрытых комплексах могут требоваться дополнительные разрешения." },
            ].map((faq, i) => (
