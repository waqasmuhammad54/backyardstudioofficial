...
export const metadata: Metadata = {
  ...
  description:
 "Фотосъёмка недвижимости в Дубае от AED 1,500. Интерьеры, экстерьеры, аэросъёмка дроном, видеотуры. Backyard Studio — доставка за 24 часа.",
  alternates: {
 ...
 description: "Профессиональная съёмка квартир, вилл и коммерческой недвижимости в Дубае. дрон, видеотуры, доставка за 24 часа.",
...
export default function RealEstatePhotographyRuPage() {
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
 text: "Да, аэросъёмка выполняется по коммерческой лицензии для полётов по всему ОАЭ. Аэросъёмка резко повышает привлекательность листинга — особенно для вилл, пентхаусов и объектов с видом. Все полёты легальны, застрахованы и согласованы с соответствующими органами.",
        },
      },
      {
        "@type": "Question",
 ...
 { title: "Аэросъёмка дроном", desc: "Вид сверху раскрывает расположение объекта, вид из окна, близость к морю или паркам — то, что невозможно показать с земли." },
 ...
 { type: "Пакет с аэросъёмкой", price: "от AED 3,500", desc: "Фото интерьера + экстерьера + 5–8 аэроснимков дроном. Для объектов с видом или расположенных в закрытых комплексах." },
 ...
 { q: "Можно ли снять дрон в жилых комплексах Дубая?", a: "В большинстве случаев — да, при наличии действующей лицензия на полёт и согласования с управляющей компанией комплекса. Мы берём на себя всю организацию. В некоторых закрытых комплексах могут требоваться дополнительные разрешения." },
            ].map((faq, i) => (
