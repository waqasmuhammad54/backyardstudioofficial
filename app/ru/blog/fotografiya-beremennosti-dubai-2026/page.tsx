  ...
  return (
    <>
      ...
      <article style={{ fontFamily: "Inter, sans-serif", maxWidth: "860px", margin: "0 auto", padding: "4rem 2rem", color: "var(--cream)", lineHeight: "1.85" }}>
        ...
        <h2 style={{ fontSize: "1.5rem", fontWeight: 700, color: "var(--gold)", marginBottom: "1rem", marginTop: "3rem" }}>
          Как подготовиться к фотосессии беременности?
        </h2>
        <p style={{ marginBottom: "1.2rem" }}>
          Лучшее время для съёмки беременности — 28–34 неделя: живот уже хорошо оформлен, 
          мама чувствует себя комфортно и подвижна. Мы рекомендуем приходить на съёмку 
          утром или в первой половине дня, когда уровень усталости минимален. На фотосессию 
          можно прийти с партнёром или старшим ребёнком — семейные кадры создают особую 
          теплоту.
        </p>
        <p style={{ marginBottom: "1.2rem" }}>
          По вопросу одежды: мы рекомендуем несколько образов — от облегающего трикотажа 
          до лёгкого платья с разрезом. Белые, кремовые и пыльно-розовые оттенки работают 
          лучше всего на тёмном фоне нашей студии. В пакет входит бесплатная консультация 
          перед съёмкой, где мы обсуждаем стиль, образы и предпочтения.
        </p>
        <h2 style={{ fontSize: "1.5rem", fontWeight: 700, color: "var(--gold)", marginBottom: "1rem", marginTop: "3rem" }}>
          Студийная съёмка или выездная — что лучше?
        </h2>
        <p style={{ marginBottom: "1.2rem" }}>
          Студийная съёмка беременности даёт максимальный контроль над светом и атмосферой 
          — от нежной минималистичной эстетики до драматичных контрастных кадров. Выездная 
          съёмка на природе или в любимом месте семьи добавляет личный смысл и естественный 
          фон. Многие клиенты выбирают комбинированный формат: начинают в студии, 
          заканчивают на набережной или в саду.
        </p>
