  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Да, при наличии разрешения от площадки. Мы имеем лицензию GCAA и заранее координируем всё с администрацией отеля или зала. Аэросъёмка добавляет элегантность и масштаб свадебным кадрам.",
        },
      },
    ],
  };
