  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Да, при наличии разрешения от площадки. Аэросъёмка выполняется по лицензии GCAA и заранее координируем всё с администрацией отеля или зала. Аэросъёмка добавляет элегантность и масштаб свадебным кадрам.",
        },
      },
    ],
  };
