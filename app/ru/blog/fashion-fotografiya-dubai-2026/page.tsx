  ...
  return (
    <>
      ...
      <article style={{ fontFamily: "Inter, sans-serif", maxWidth: "860px", margin: "0 auto", padding: "4rem 2rem", color: "var(--cream)", lineHeight: "1.85" }}>
        ...
        <h2 style={{ fontSize: "1.5rem", fontWeight: 700, color: "var(--gold)", marginBottom: "1rem", marginTop: "3rem" }}>
          Что входит в нашу услугу фэшн съёмки?
        </h2>
        <p style={{ marginBottom: "1.2rem" }}>
          Полный пакет фэшн съёмки включает: консультацию по концепции и мудборду, помощь 
          с координацией модели через проверенные агентства Дубая, профессиональный свет 
          (студийный или выездной), ретушь и цветокоррекцию всех финальных файлов, а также 
          экспорт в нужных форматах для Instagram, сайта и печатной продукции.
        </p>
        <p style={{ marginBottom: "1.2rem" }}>
          После съёмки вы получаете полную галерею обработанных изображений через защищённую 
          онлайн-ссылку. Срок доставки — 5–7 рабочих дней. При необходимости доступна 
          ускоренная доставка за 48 часов.
        </p>
        <h2 style={{ fontSize: "1.5rem", fontWeight: 700, color: "var(--gold)", marginBottom: "1rem", marginTop: "3rem" }}>
          Почему именно Дубай для фэшн контента?
        </h2>
        <p style={{ marginBottom: "1.2rem" }}>
          Дубай предлагает уникальную комбинацию: архитектурные фоны мирового класса, 
          всесезонная съёмка в помещениях, лучшее естественное освещение в зимние месяцы 
          (октябрь–апрель) и доступ к профессиональному модельному пулу. Город давно стал 
          региональным хабом для брендов из Европы, Азии и Ближнего Востока, которые создают 
          кампании для арабского и международного рынков.
        </p>
        <p style={{ marginBottom: "1.2rem" }}>
          Дополнительный плюс — гибкие локации за один день: утро на Al Bastakiya (восточная 
          эстетика), обед в студии для контролируемого света, золотой час на набережной 
          Дубай Крик. Весь этот разброс географии и атмосфер умещается в один продуктивный 
          съёмочный день.
        </p>
