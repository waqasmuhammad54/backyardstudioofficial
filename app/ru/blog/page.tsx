...
export const metadata: Metadata = {
 ...
 description: "Свадебная съёмка, корпоративное видео, аэросъёмка. Реальные цены и советы.",
 ...
 description: "Советы по видеосъёмке, цены, аэросъёмка. Экспертный контент.",
    images: ["/og-image.jpg"],
  },
};
...
const POSTS = [
 ...
 { title: "Съёмка недвижимости в Дубае 2026 — цены на фото и видео", desc: "От 2 500 AED: видеотуры, элитные виллы, аэросъёмка. Реальные цены и что входит в каждый пакет.", href: "/ru/blog/semka-nedvizhimosti-dubai-2026", date: "Май 2026", featured: true },
