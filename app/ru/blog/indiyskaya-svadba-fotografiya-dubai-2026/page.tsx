  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
 text: "Да, аэросъёмка выполняется по действующей лицензии на коммерческую аэросъёмку. Дрон-съёмка процессии бараат добавляет кинематографический размах, который невозможно получить наземными камерами.",
        },
      },
      {
        "@type": "Question",
