  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Да, наша команда имеет лицензию GCAA на коммерческую аэросъёмку. Дрон-съёмка процессии бараат добавляет кинематографический размах, который невозможно получить наземными камерами.",
        },
      },
      {
        "@type": "Question",
