...
export const metadata: Metadata = {
 ...
 description: "Корпоративное видео, свадьбы, мероприятия, аэросъёмка, контент для соцсетей. Цены от 2 000 AED.",
  ...
  twitter: {
    ...
    title: "Услуги видеосъёмки в Дубае — Backyard Studio Official",
 description: "Корпоративное видео·свадьбы·аэросъёмка. Цены от 2 000 AED.",
    images: ["/og-image.jpg"],
  },
};
...
const SERVICES = [
 ...
 { icon: "🚁", title: "Аэросъёмка дроном", desc: "Кинематографическая аэросъёмка для недвижимости, мероприятий, рекламы и туризма в ОАЭ.", price: "от 2 000 AED" },
...
const SERVICES_FAQS = [
 ...
 a: "Мы предлагаем полный спектр услуг: корпоративное видео, свадебная съёмка, съёмка мероприятий, аэросъёмка дроном (аэросъёмка), контент для соцсетей, фотосъёмка недвижимости, фудфотография и предметная съёмка. Более 2,400 проектов по всем ОАЭ.",
  },
  {
  ...
  {
 q: "Есть ли у вас аэросъёмка на аэросъёмку дроном в ОАЭ?",
 a: "Да. Backyard Studio Official имеет необходимую лицензию (Генеральное управление гражданской авиации) на коммерческую аэросъёмку. Это гарантирует легальность всех наших дроновых съёмок по всем эмиратам ОАЭ.",
  },
  {
...
export default function RuServicesPage() {
 ...
 a: "Мы снимаем на камеры Sony FX серии и Blackmagic Cinema, используем световое оборудование Aputure и беспроводные микрофоны Sennheiser. Для аэросъёмки — дроны DJI Inspire и Mavic серии. Оборудование подбирается под требования каждого конкретного проекта.",
              },
              {
                q: "Работаете ли вы с государственными структурами в ОАЭ?",
 a: "Да. Мы имеем опыт работы с государственными и полугосударственными структурами в ОАЭ. Соблюдаем все необходимые процедуры и получаем требуемые разрешения для проектов государственного сектора, включая разрешения на съёмку на государственных объектах и полёты дрона в зонах.",
              },
              {
