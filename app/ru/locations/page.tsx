...
const LOCATIONS_FAQS = [
  ...
  { q: "Какие виды съёмки доступны по всему ОАЭ?", a: "Мы предлагаем полный спектр производственных услуг по всем эмиратам: видеосъёмка мероприятий, свадебная фотография, DVC (цифровые рекламные ролики), Instagram Reels и TikTok, корпоративные фильмы, аэросъёмка дроном (аэросъёмка, одобренная GCAA), видеоотзывы и рекламная съёмка." },
];
