...
const TESTIMONIALS = [
 ...
 { name: "Ирина", service: "Аэросъёмка ", stars: 5, quote: "Аэросъёмка добавила совершенно другое измерение к нашему контенту. Всё организовано юридически грамотно, с разрешениями. Результат превзошёл ожидания." },
