...
export const metadata: Metadata = {
  ...
  description: "Цены на производство в Дубае 2026: свадебная съёмка от 7 500 AED, DVC от 15 000 AED, съёмка мероприятий от 3 000 AED, контент для соцсетей от 2 500 AED. Расчёт за 2 часа.",
  keywords: ["стоимость свадебной съёмки Дубай", "цена видеопроизводства ОАЭ", "съёмка мероприятий цена Дубай", "контент для соцсетей цена Дубай", "пакеты производства Дубай 2026"],
  alternates: {
  ...
  openGraph: {
    ...
    description: "Прозрачные цены: свадьбы от 7 500 AED, DVC от 15 000 AED, мероприятия от 3 000 AED. Бесплатный расчёт за 2 часа.",
