...
export const metadata: Metadata = {
  ...
  description: "Цены на производство в Дубае 2026: свадебная съёмка от 1 799 AED, DVС от 15 000 AED, аэросъёмка от 2 000 AED, контент для соцсетей от 2 500 AED. Лицензия GCAA.",
  ...
  openGraph: {
    ...
    description: "Прозрачные цены: свадьбы от 1 799 AED, DVC от 15 000 AED, аэросъёмка от 2 000 AED. Бесплатный расчёт за 2 часа.",
...
const PACKAGES_RU = [
  {
    ...
    anchor: "wedding",
    intro: "Самые востребованные свадебные пакеты в Дубае — от доступной фотографии до многодневных производств. Доставка в течение 48 часов по каждому пакету.",
    plans: [
      { name: "Эссеншл", price: "1 799 AED", label: "Доступная фотография", desc: "Бюджетная профессиональная фотография для камерных церемоний и регистраций.", includes: ["1 профессиональный фотограф", "3 часа съёмки", "100+ обработанных фото", "Онлайн-галерея доставки", "Доставка за 48 часов", "Добавить видео от 1 200 AED"], featured: false },
      { name: "Сильвер", price: "3 500 AED", label: "Съёмка полдня", desc: "Идеально для гражданских, никах-церемоний и камерных торжеств.", includes: ["1 фотограф + 1 видеограф", "4 часа съёмки", "150–200 обработанных фото", "Highlight-видео 3 мин.", "Онлайн-галерея", "Доставка за 48 часов"], featured: false },
      { name: "Голд", price: "8 500 AED", label: "Полный день свадьбы", desc: "Наш самый популярный пакет — полное покрытие свадебного дня от подготовки до приёма.", includes: ["2 фотографа + 2 видеографа", "10 часов съёмки", "400–600 обработанных фото", "Кинематографический highlight-фильм (5–8 мин.)", "Аэросъёмка дроном (GCAA)", "Тизер-клип в тот же день", "Полная доставка за 48 часов", "Предсвадебная консультация"], featured: true },
      { name: "Платинум", price: "18 000+ AED", label: "Премиальный многодневный", desc: "Индийские свадьбы, многодневные мероприятия, торжества по всему ОАЭ.", includes: ["Полное многодневное покрытие", "3+ фотографа и видеографа", "Галерея 1 000+ фото", "Полноформатный свадебный фильм", "Reels для соцсетей в тот же день", "Дрон — все локации", "Предсвадебная съёмка включена", "Гарантия доставки 48 часов"], featured: false },
    ],
  },
  {
...
const FAQS_RU = [
  { q: "Сколько стоит свадебный фотограф в Дубае?", a: "Стоимость свадебной съёмки в Дубае варьируется от 1 799 AED за доступный пакет Эссеншл до 25 000+ AED за полную многодневную индийскую свадьбу с дроном, видео, предсвадебной съёмкой и highlight в тот же день. Наш самый популярный пакет полного дня (Голд) стоит 8 500 AED и включает 2 фотографа, 2 видеографа, дрон и доставку за 48 часов." },
