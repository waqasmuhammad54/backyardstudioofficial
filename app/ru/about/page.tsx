...
export const metadata: Metadata = {
 ...
 description: "Узнайте о Backyard Studio Official — ведущей креативной продюсерской компании в Дубае. Основана в 2019 году Фахадом Икбалом Баттом и Саедом Мазаром Зайди. Более 2 400 проектов. Аэросъёмка.",
 ...
 description: "Ведущая креативная продюсерская компания Дубая. Основана 2019. Более 2 400 проектов, аэросъёмка, команда с опытом 20+ лет.",
  ...
  twitter: {
    ...
    title: "О нас — Backyard Studio Official — Дубай",
 description: "Основана в 2019 году Фахадом Икбалом Баттом. Более 2 400 проектов.. Аэросъёмка.",
    images: ["/og-image.jpg"],
  },
};
...
const MILESTONES_RU = [
 ...
 { year: "2024", event: "Добавлена аэросъёмка — сервис по всему ОАЭ" },
