...
export const metadata: Metadata = {
  ...
  description:
 "Профессиональная видеосъёмка и фотография в Дубае и ОАЭ. Корпоративное видео, свадебная съёмка, съёмка мероприятий, контент для соцсетей. Более 2,400 реализованных проектов.. Аэросъёмка.",
  alternates: {
 ...
 description: "Корпоративное видео, свадьбы, съёмка мероприятий. 2,400+ проектов по всем ОАЭ.. Аэросъёмка.",
    images:      ["/og-image.jpg"],
  },
...
const LOCAL_BUSINESS_RU = {
  ...
  "description":
 "Профессиональная видеосъёмка и фотография в Дубае. Корпоративное видео, свадебная съёмка, контент для соцсетей, съёмка мероприятий.. Аэросъёмка.",
  "areaServed": [
