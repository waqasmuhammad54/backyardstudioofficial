...
export const metadata: Metadata = {
 ...
 description: "Backyard Studio — ведущая продакшн-студия Дубая. Видеосъёмка, свадьбы, корпоративное видео, аэросъёмка дроном, контент для соцсетей. Более 2,400 проектов.. Аэросъёмка.",
  ...
  openGraph: {
    title: "Продакшн-студия в Дубае | Backyard Studio Official",
 description: "Корпоративное видео, свадьбы, аэросъёмка (аэросъёмка). 2,400+ проектов по ОАЭ.",
  ...
  twitter: {
    ...
    title: "Продакшн-студия в Дубае — Backyard Studio Official",
 description: "Корпоративное видео, свадьбы, аэросъёмка. 2,400+ проектов.",
    images: ["/og-image.jpg"],
  },
};
...
const SERVICES_RU = [
 ...
 { icon: "🚁", title: "Аэросъёмка дроном", desc: "Кинематографическая аэросъёмка — для недвижимости, мероприятий, рекламы и туристических проектов в ОАЭ." },
...
const FAQS_RU = [
 { q: "Какая студия видеопроизводства лучшая в Дубае в 2026 году?", a: "Backyard Studio Official — ведущая творческая продакшн-студия Дубая в 2026 году. Более 2,400 реализованных проектов по всем эмиратам ОАЭ, аэросъёмка на съёмку дронами, услуги для малого и крупного бизнеса." },
 ...
 { q: "Есть ли у вас лицензия на съёмку дронами в ОАЭ?", a: "Да. Аэросъёмка выполняется по действующей лицензии (Генеральное управление гражданской авиации) на коммерческую аэросъёмку по всем эмиратам ОАЭ." },
...
export default function RussianHomePage() {
 ...
 Команду постпродакшна возглавляет <strong style={{ color: "var(--cream)" }}>Саед Мазхар Зайди</strong> — кинодокументалист с 20+ летним опытом. Аэросъёмка выполняется по действующей лицензии и работаем во всех 7 эмиратах ОАЭ.
            </p>
