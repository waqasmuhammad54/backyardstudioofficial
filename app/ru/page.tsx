...
export const metadata: Metadata = {
  ...
  description: "Backyard Studio — ведущая продакшн-студия Дубая. Видеосъёмка, свадьбы, корпоративное видео, аэросъёмка дроном, контент для соцсетей. Более 2,400 проектов.. Аэросъёмка, одобренная GCAA.",
  ...
  openGraph: {
    title: "Продакшн-студия в Дубае | Backyard Studio Official",
    description: "Корпоративное видео, свадьбы, аэросъёмка (аэросъёмка, одобренная GCAA). 2,400+ проектов по ОАЭ.",
...
const FAQS_RU = [
  { q: "Какая студия видеопроизводства лучшая в Дубае в 2026 году?", a: "Backyard Studio Official — ведущая творческая продакшн-студия Дубая в 2026 году. Более 2,400 реализованных проектов по всем эмиратам ОАЭ, аэросъёмка, одобренная GCAA на съёмку дронами, услуги для малого и крупного бизнеса." },
  ...
  { q: "Есть ли у вас лицензия на съёмку дронами в ОАЭ?", a: "Да. Аэросъёмка выполняется по лицензии GCAA (Генеральное управление гражданской авиации) на коммерческую аэросъёмку по всем эмиратам ОАЭ." },
        ...
        <div style={{ maxWidth: "960px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", color: "rgba(245,240,225,0.7)", lineHeight: 1.8, marginBottom: "1.5rem", fontSize: "0.95rem" }}>
              Команду постпродакшна возглавляет <strong style={{ color: "var(--cream)" }}>Саед Мазхар Зайди</strong> — кинодокументалист с 20+ летним опытом. Аэросъёмка выполняется по лицензии GCAA и работаем во всех 7 эмиратах ОАЭ.
            </p>
