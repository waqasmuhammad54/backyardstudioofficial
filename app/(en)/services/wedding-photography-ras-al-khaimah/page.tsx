...
export const metadata: Metadata = {
  title: "Wedding Photographer Ras Al Khaimah | Beach & Desert Weddings from AED 1,799 — Backyard Studio Official",
  description:
    "Wedding photographer in Ras Al Khaimah — Waldorf Astoria, Ritz-Carlton Al Wadi desert weddings, Rixos Bab Al Bahr & Jebel Jais backdrops. Photo + video from AED 1,799, GCAA drone, no travel fees, 48-hour delivery.",
  keywords: [
  ...
  openGraph: {
    title: "Wedding Photographer Ras Al Khaimah | From AED 1,799 — Backyard Studio Official",
  ...
  twitter: { card: "summary_large_image", title: "Wedding Photographer Ras Al Khaimah | From AED 1,799", description: "Beach & desert resort weddings with GCAA drone. 48-hour delivery.", images: ["/images/wedding/wedding-15.webp"] },
};

const FAQS = [
  {
    q: "How much does a wedding photographer cost in Ras Al Khaimah?",
    a: "The same as our Dubai pricing — Essential photography AED 1,799, Silver photo + video AED 3,500, full-day Gold AED 8,500 with GCAA drone and same-day teaser, Platinum multi-day AED 18,000+. RAK resort weddings incur zero travel fees; our crews drive up from Dubai weekly.",
  },
  {
...
export default function WeddingPhotographyRAKPage() {
  ...
  const service = servicePageSchema({
    ...
    description: "Beach and desert resort wedding photography in Ras Al Khaimah — from AED 1,799, GCAA drone, no travel fees.",
    url: PAGE_URL,
    price: "1799",
  });
