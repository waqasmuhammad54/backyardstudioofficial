...
const SERVICE_DATA: Record<string, { title: string; description: string; includes: string[]; faqs: { q: string; a: string }[] }> = {
  "event-shoots": {
    title: "Event Shoots",
    description: "Backyard Studio Official is one of Dubai's most trusted event photography and videography companies. We cover corporate events, gala dinners, product launches, GITEX and Expo-scale exhibitions, government ceremonies, brand activations, sports events, and private celebrations — anywhere in the UAE, at any scale.\n\nEvent coverage is time-critical and irreversible. Unlike a commercial shoot, there is no second take on the keynote speech, the award presentation, or the moment the CEO shakes hands with the minister. Our event teams are built around this reality: senior photographers and videographers who make the right decision in real time, not after the moment has passed.\n\nEvery event booking includes a minimum of two camera operators for full redundancy. Our team arrives 45–60 minutes before guests for venue walkthrough, lighting assessment, and coordination with your event management team. We work invisibly — guests should not notice us, but we should never miss them.\n\nDeliverables are structured around your timeline. A same-day teaser — 60 seconds, 30 stills — is delivered within 4–6 hours for immediate social media use while the event is still trending. The full edited highlight reel and complete photography gallery follow within 48 hours via private online delivery.\n\nWe cover every major UAE event venue: Dubai World Trade Centre, Expo City Dubai, DIFC Gate, Atlantis The Palm, Armani Hotel, Abu Dhabi National Exhibition Centre, Yas Island venues, Sharjah Expo Centre, and all hotel ballrooms and conference facilities across the emirates. Our teams know these venues, their lighting quirks, and the angles that work — we do not discover this on your event day.\n\nEvent photography packages start from AED 2,000 for a 4-hour single-photographer booking. Combined photography and videography from AED 3,500. Full-day multi-crew event packages from AED 8,000. Live streaming add-on from AED 4,000.",
  ...
  "photo-shoots": {
    ...
    description: "Backyard Studio Official is one of Dubai's top photo shoot companies for weddings, portraits, corporate, lifestyle, and commercial photography. Our photography team produces editorial-quality images across every category — pre-wedding photoshoots, lifestyle sessions, corporate headshots, personal branding photography, product photography, and family portraits.\n\nDubai offers a remarkable range of photography locations: the Burj Khalifa and Downtown skyline for dramatic urban backdrops, Old Dubai and Al Fahidi for heritage atmosphere, the desert at Al Qudra for golden-hour beauty shots, Palm Jumeirah and the beach for coastal lifestyle imagery, and the numerous architectural landmarks that make the city instantly recognisable worldwide. We work across all these environments and know exactly which locations deliver which results, at which time of day.\n\nOur photography team includes specialists for each content type: portrait photographers with extensive experience in personal branding and professional headshots, lifestyle photographers who excel at natural, candid couple and family sessions, commercial photographers for product and brand content, and wedding photographers for pre-wedding shoots and wedding day coverage.\n\nEvery photo shoot includes: pre-shoot consultation to understand goals and style references, location recommendation or scouting, professional direction on the day (posing, expression, composition), full shoot delivery within 5 business days, and a minimum of 50 edited images per half-day session with professional retouching.\n\nPhoto shoot packages start from AED 1,200 for a 2-hour portrait or headshot session. Lifestyle and couple sessions from AED 2,000. Family sessions from AED 2,500. Commercial photography packages from AED 3,500.",
  ...
  "dvcs": {
    ...
    description: "Backyard Studio Official produces digital video commercials (DVCs) for UAE brands, regional retailers, e-commerce businesses, and international companies entering the Gulf market. A DVC is not a brand film — it is a conversion tool. We approach every brief with a performance-first mindset: what emotion needs to be triggered, what action needs to be driven, and how do we achieve both before the viewer reaches for the skip button.\n\nThe UAE's commercial video market is one of the most sophisticated in the world. Your DVC is competing for attention against the global creative output of every brand that has ever run a campaign on Instagram, TikTok, YouTube, and Snapchat. Generic, template-driven commercial content fails here — audiences are too visually literate and expectations are too high. The brands that win are those that invest in production quality that reflects their market position.\n\nOur DVC process begins with a creative discovery session: understanding the brand, the specific campaign objective, the target audience segment, and the platform the content will run on. A DVC for Meta performance campaigns is a fundamentally different brief from a YouTube pre-roll or a Snapchat Discover placement — and our creative direction reflects these differences.\n\nCreative development covers scriptwriting, storyboarding, visual references, location options, and casting direction. Once the creative direction is approved, we move into full pre-production: talent casting, location scouting and permits, shot list, and schedule. Production is typically a single efficient shoot day for most standard DVC scopes, with our experienced director managing pacing and coverage.\n\nPost-production delivers the complete DVC with offline edit, colour grade, sound design, licensed music, motion graphics and supers, and all platform-specific format cuts: 16:9 for YouTube and OTT, 9:16 for TikTok and Instagram Stories, 1:1 for feed, 4:5 for Meta performance. Two revision rounds are included.\n\nDVC production starts from AED 8,000 for a single-location 30-second commercial. Multi-location campaigns and longer-form content quoted on brief. Rush production (7 days) available.",
  ...
  "reels": {
    ...
    description: "Backyard Studio Official is Dubai's leading Instagram Reels and short-form video production company. We produce vertical-first, platform-native Reels content for UAE brands, F&B businesses, hospitality groups, retail chains, content creators, and individual professionals.\n\nInstagram Reels in the UAE operates in one of the most visually competitive environments on the platform globally. Dubai's creators and brands set a standard that demands genuine production quality to break through. A phone-shot Reel with basic editing simply does not perform the same way as a professionally produced vertical video with intentional hooks, sound design, and motion work — and the algorithm differences between these two are significant and measurable.\n\nWe approach Reels production with a performance-first mindset: the hook (first 1.5 seconds), the format (talking head, B-roll montage, tutorial, day-in-life, transformation), the caption strategy, and the audio selection are all decided before we shoot. Every creative decision connects back to the Reel's specific purpose — whether that's reach, saves, profile visits, or direct conversions.\n\nOur Reels production service includes: content strategy session, shot list development, professional crew (director/DP, sound, lighting), all location and prop coordination, editing to platform spec (9:16, 1080×1920px), colour grade, text overlays and supers, licensed audio, and delivery in both Instagram-optimised and WhatsApp-ready formats.\n\nWe also produce Reels as part of comprehensive social media content day packages, where a single shoot day delivers 6–10 Reels plus 20–30 photography assets — a complete content calendar for the next 6–8 weeks.\n\nSingle Reel production from AED 1,200. Multi-Reel shoot day packages from AED 3,500 (6–10 Reels). Monthly Reels retainer from AED 5,000.",
  ...
  "ads-shooting": {
    ...
    description: "Backyard Studio Official is Dubai's performance-first ad production company. We produce Meta (Facebook and Instagram) ad content, TikTok paid campaign creatives, YouTube pre-rolls and bumper ads, Snapchat ad content, Out-Of-Home billboard visuals, and broadcast/IPTV commercial content — all built around one question: will this ad make someone take action?\n\nAd content in the UAE has to work across a uniquely fragmented audience. Arabic and English audiences respond to different visual languages, different humour registers, different trust signals, and different calls to action. South Asian, East Asian, and Western expat consumers bring further audience layers. A single ad that tries to speak to everyone often speaks to no one. Our ad production teams understand these audience dynamics and build creative that targets precisely — whether that is a single audience or a campaign of multiple variants.\n\nWe produce multiple creative variants as standard for every ad campaign, not as an add-on. A/B testing is the baseline expectation for performance media, and our production process is designed to deliver 3–5 creative variants efficiently within a single shoot day. Different hooks, different value propositions, different talent, and different environments — tested systematically against your campaign objective.\n\nPre-production covers creative concept development, scripting, casting (in-house talent pool or external), location sourcing and permits, and shot list. Production is led by an experienced commercial director with a full crew. Post-production delivers all platform-compliant exports with motion graphics, supers, captions, and any required Arabic versioning.\n\nWe work closely with media agencies and performance marketing teams — providing final files in the exact specifications each platform requires, with the metadata, aspect ratios, and file sizes their ad managers demand. If you have a media team placing the buy, we make their job frictionless.\n\nAd production packages start from AED 5,000 for a 3-variant social ad package. Full campaign production with multiple formats and bilingual Arabic/English delivery from AED 12,000.",
  ...
  "aerial-drone": {
    ...
    description: "Backyard Studio Official is one of the UAE's fully GCAA-licensed drone production companies, authorised to fly commercially across all 7 UAE emirates. Every aerial shoot is legally compliant, comprehensively insured, and coordinated with the relevant authorities — so your production is protected from every angle, not just the sky.\n\nAerial footage changes what a project communicates. A real estate listing with drone footage sells faster and at higher prices. An event recap with an aerial establishing shot communicates scale instantly. A brand film with mountain or desert aerials from RAK or Al Ain conveys ambition that no ground-level camera can match. We understand what drone footage is actually for in each context, and we plan every flight accordingly.\n\nOur GCAA-licensed pilots operate DJI Inspire 2 and Mavic 3 Cine platforms, delivering cinematic 4K footage up to 120fps for slow-motion sequences. We cover the full UAE aerial landscape: the Downtown Dubai skyline and Burj Khalifa corridor, Palm Jumeirah and Bluewaters, Dubai Creek and Heritage Area, Abu Dhabi Corniche and Yas Island, the Hajar Mountains and Jebel Jais in RAK, desert dunes in Al Ain and Liwa, and coastal developments from Fujairah to Umm Al Quwain.\n\nFor real estate, we specialise in property aerial photography that positions the asset within its community context — the proximity to coast, the surrounding development, the access routes — information that listing photography alone cannot communicate. For events and weddings, our drones capture the venue scale and the gathering of people in a single frame that becomes the defining image of the occasion.\n\nAll aerial shoots include pre-flight planning, full authority coordination, on-site safety briefing, complete 4K raw file delivery, and a colour-graded aerial highlight cut within 24 hours. Integration with ground-level production teams is standard — we work alongside your photographer, videographer, or our own ground crew seamlessly.\n\nDrone session pricing starts from AED 2,500 for a standalone 2-hour aerial shoot. Combined aerial and ground packages for real estate start from AED 4,500. Event drone add-ons are priced from AED 1,800 per event.",
  ...
  "testimonial-videos": {
    ...
    description: "Backyard Studio Official produces professional testimonial videos for UAE businesses, brands, and service providers. Our testimonial films are not the stiff, overlit, "say something nice about us" kind that modern audiences immediately distrust. They are genuine client stories, well-directed and thoughtfully edited, that function as the most persuasive sales tool a business can have.\n\nA genuine testimonial video does what no marketing copy can: it transfers trust. When a prospective client sees a real person — someone who looks like them, works in a similar industry, had a similar problem — explaining how a product or service solved their problem, the credibility is qualitatively different from any branded claim. But capturing that authentic quality on film requires directing skill, a relaxed environment, and a structured interview approach that draws out natural, specific storytelling rather than rehearsed praise.\n\nOur testimonial process: pre-interview briefing (we coach clients on what to focus on without scripting them), one-camera or two-camera setup depending on production level required, professional lighting that flatters the subject without looking like a studio setup, directed interview conducted by our experienced interviewer, B-roll capture of the client's business environment, and edit structure that builds a narrative arc: problem → solution → outcome.\n\nWe produce testimonials for SaaS and tech companies, professional services firms, real estate developers, healthcare providers, hospitality groups, and consumer brands. Multi-testimonial production days (filming 3–5 clients in one location) are the most cost-efficient format.\n\nSingle testimonial video (2–3 minutes): AED 2,500. Multi-client testimonial day (5 testimonials): AED 7,500. Social media testimonial cuts included in all packages.",
  ...
  "event-video-editing": {
    ...
    description: "Backyard Studio Official provides professional event video editing services for UAE businesses, event agencies, wedding coordinators, and individuals who have raw event footage that needs professional post-production treatment.\n\nOur post-production team in Dubai handles all types of event editing: corporate conference highlights, gala dinner recaps, product launch films, wedding highlight films, award ceremony coverage, sports events, and entertainment event recaps. If you have footage — from one camera or multiple cameras — we can turn it into a polished, branded edit.\n\nThe editing process covers multi-camera synchronisation, selection and assembly of the best coverage, narrative structure (every event film tells a story — arrival to climax to resolution), professional colour grade matching across cameras and lighting conditions, sound design and music selection with proper licensing, motion graphics and title cards, lower thirds for speakers and key moments, and all required format exports.\n\nWe accept footage from any camera format: Sony, Canon, ARRI, DJI drone footage, GoPro POV, iPhone, and any broadcast or cinema camera. Files can be shared via WeTransfer, Google Drive, Dropbox, or physical hard drive delivery to our Dubai studio.\n\nTurnaround on a standard 4–6 hour event with 2 cameras is 5–7 business days for a 3–5 minute highlight film. Rush edits (48 hours) are available for events where social media posting timing is critical. Same-day teaser edits (60 seconds, social spec) are available from AED 800.\n\nEvent video editing starts from AED 1,500 for a 3-minute highlight film from a single-camera event. Multi-camera events with longer coverage from AED 2,500. Wedding film editing from AED 2,000 per film.",
  ...
  "social-media-shoots": {
    ...
    description: "Backyard Studio Official is one of Dubai's leading social media content production companies. We produce photography and video content specifically engineered for Instagram, TikTok, YouTube, LinkedIn, and Snapchat — not repurposed corporate content retrofitted to social dimensions, but platform-native creative built from the ground up for the feed, the story, and the scroll.\n\nSocial media content in the UAE operates in a uniquely competitive environment. Dubai's Instagram density — the concentration of high-production-value content from luxury brands, hospitality businesses, real estate developers, and influencers — means that below-average content is invisible regardless of ad spend. The brands winning organic reach and engagement are those investing in production quality that belongs on the platform, not just on it.\n\nWe structure social media shoot days to maximise content output efficiently. A standard full-day social shoot with Backyard Studio Official typically delivers: 6–10 Reels or TikTok videos, 20–30 photography assets for feed and stories, 15–20 stories-format cuts, and a BTS video. This content volume feeds a content calendar for 4–6 weeks, making a monthly production shoot the most cost-effective model for most UAE brands.\n\nOur pre-shoot process is as important as the shoot day itself. A content strategy session maps out the shot list, the hooks, the messaging, and the platform-specific requirements before the camera turns on. We build the shot list around your actual content calendar — what you need to post, when, and why — not a generic template.\n\nWe work with UAE brands across every category: F&B and hospitality, luxury retail, real estate, health and wellness, fashion, automotive, tech, and professional services. We also work with individual content creators and influencers who need to level up their production quality without hiring a full in-house team.\n\nSocial media shoot packages start from AED 3,500 for a half-day session delivering 10–15 assets. Monthly retainer packages from AED 6,500 including one full shoot day and editing. videos that perform in paid ad campaigns — our social media shoots deliver content that looks premium and performs commercially.\n\nWe combine videography and photography in a single shoot day so your brand gets a full suite of assets: video for Reels, TikTok and Stories; stills for feed, ads and web. No separate bookings, no mixed-quality deliverables — everything in one unified creative direction.",
  ...
  "automotive": {
    ...
    description: "Backyard Studio Official is one of Dubai's leading automotive videography and photography companies. We produce visual content for UAE car dealerships, regional distributors, automotive brands, private sellers of luxury vehicles, car events, and motorsport coverage across Dubai and the GCC.\n\nAutomotive photography and film is a highly specialist discipline. Vehicles have specific surfaces, reflections, and proportions that respond to light in ways that most commercial photography teams are not equipped to handle. The difference between an automotive image that makes a car look desirable and one that simply records it being there comes down to lighting setup, camera angle, lens choice, and colour grade — variables that our automotive production team controls precisely on every shoot.\n\nWe produce three main types of automotive content: static photography (studio, outdoor, lifestyle backgrounds), motion videography (rolling shots, tracking shots, interior fly-throughs), and marketing campaign content (lifestyle-integrated, talent-driven, narrative-led). Most dealer and distributor briefs require all three, and we build integrated shoot days that deliver all content types efficiently.\n\nOur Dubai locations for automotive work include the Al Qudra road system, Al Ain desert tracks, Dubai Desert Conservation Reserve access roads, Jebel Jais mountain roads in RAK, the Dubai Autodrome facility, and urban architecture settings around Downtown and DIFC. We coordinate location access and permits as part of every automotive production.\n\nEquipment includes cinema prime lenses, remote head stabilisation rigs for tracking shots, car mounts and suction cup rigs for vehicle-attached cameras, and full lighting kit for studio and outdoor setups.\n\nAutomotive photography from AED 2,500 per vehicle per session. Automotive videography packages from AED 5,500. Full campaign production (photo + video + motion) from AED 12,000.",
  ...
  "real-estate": {
    ...
    description: "Backyard Studio Official produces professional real estate photography and videography for Dubai's most demanding property market. From DIFC penthouses and Palm Jumeirah villas to off-plan developer launches and commercial real estate portfolios — we deliver property visuals that make listings sell faster and at better prices.\n\nDubai's real estate market is image-driven in a way few property markets in the world match. Buyers and tenants are comparing your listing against hundreds of others in the same area, many of them shot by professional teams. Professional photography is not a differentiator in this market — it is the baseline. What separates the listings that generate enquiries from those that sit uncontacted is the quality of the visual storytelling.\n\nWe photograph and film all property types across the UAE: residential apartments from studios to penthouses, private villas and compounds, hotel residences, short-term rental properties, commercial offices and retail spaces, warehouses and industrial units, and off-plan developer CGI and show-suite launches. Each property type has its own photography approach, which our teams apply without needing to be briefed on.\n\nOur standard real estate photography package includes interior wide-angle photography of all rooms, exterior and facade shots, twilight/dusk shots where applicable, and all images edited and delivered within 24 hours. Real estate videography packages include a 90-second walkthrough video, drone aerial (GCAA-licensed), and a 30-second social media cut — all delivered within 48 hours.\n\nFor developers, we produce complete launch campaign visuals: show apartment photography, amenity and community photography, construction progress documentation, and the drone aerial content that anchors investor presentation materials. Our developer clients include projects across Dubai, Abu Dhabi, Ras Al Khaimah, and Sharjah.\n\nPricing starts from AED 1,500 for a standard apartment photography package. Villa and luxury residential photography from AED 2,800. Combined photography, video, and drone packages from AED 4,500. Developer launch campaigns quoted on scope., walkthrough videography, and GCAA-licensed drone footage into a complete marketing asset package.\n\nIn Dubai's ultra-competitive real estate market, listing quality directly impacts price and time-on-market. Our real estate production team understands how to capture natural light, showcase space, and tell a lifestyle story that makes a buyer see themselves living in the property before they ever step inside.",
  ...
  "corporate-videography": {
    ...
    description: "Backyard Studio Official delivers professional corporate videography and photography for Dubai businesses, government entities, multinational corporations, and SMEs across all 7 UAE emirates.\n\nCorporate videography covers the full spectrum of business video needs: executive interviews and talking-head segments, office and facility tours, team culture videos, conference and seminar coverage, product demonstrations, training content, and corporate announcements. Each project type serves a distinct communication purpose, and we approach each one with a production brief that reflects that purpose rather than a generic template.\n\nOur corporate video teams are experienced at operating within corporate environments — arriving at the right time, coordinating with communications teams, keeping production footprint minimal in working offices, and capturing C-suite executives and senior professionals in ways that make them look authoritative and credible on screen. Executive interview coaching is included in every corporate booking.\n\nWe produce corporate videos in both Arabic and English, with our Arabic-speaking team members ensuring that bilingual content has the same quality and nuance in both languages. For government and semi-government entities in the UAE, bilingual production is a standard requirement that we fulfill without the complications other studios encounter.\n\nPost-production delivers broadcast-quality colour grade, professional audio mix, bilingual subtitles, motion graphics, and all required format exports. Standard turnaround is 7–10 working days; rush production available.\n\nCorporate videography packages start from AED 3,500 for a single-location executive interview setup. Full corporate content day (office tour, multiple interviews, B-roll) from AED 7,500. Monthly retainer packages available for businesses with ongoing video needs.",
  ...
  "youtube-content": {
    ...
    description: "Backyard Studio Official produces professional YouTube video content for UAE brands, businesses, content creators, and media companies. From single episodes to full channel content strategies, we handle the entire YouTube production pipeline: strategy, scripting, filming, editing, and thumbnail creation.\n\nYouTube is the world's second-largest search engine, and in the UAE its penetration among professionals, expats, and young Arabic-speaking audiences is among the highest globally. A YouTube channel done properly is one of the highest-ROI content investments a brand can make — the content compounds over time, driving search traffic, brand authority, and lead generation years after it was produced.\n\nWe work with three types of YouTube clients: brands building educational or thought-leadership channels to generate inbound leads, businesses producing product or service videos that appear in YouTube search results, and individual creators who need production support to scale their content quality beyond what they can produce alone.\n\nEach YouTube project starts with a content strategy session: what keywords and topics the channel should own, what video formats work best for the audience, how long episodes should be, and what the thumbnail and title formula should be. Production is then planned around these strategic decisions, not created in isolation from them.\n\nOur YouTube production packages include script support, professional filming with full crew, multi-camera options for interview/podcast formats, post-production with editing, colour grade, graphics and lower thirds, music, and exported files in YouTube-recommended specs. Thumbnail design and metadata optimisation are included.\n\nYouTube video production from AED 2,500 per episode (single camera, 5–10 minutes). Multi-camera interview/podcast format from AED 4,000 per episode. Monthly production packages for brands from AED 8,000 (4 episodes per month).",
  ...
  "event-videography": {
    ...
    description: "Backyard Studio Official provides professional event videography and photography across Dubai and all 7 UAE emirates. From intimate board dinners to stadium-scale concerts, from government inauguration ceremonies to GITEX-scale technology exhibitions — our event video teams document every occasion with cinematic quality and editorial precision.\n\nEvent videography is a specialist discipline. A corporate video director who has never covered a live event will miss the unscripted moments that define the occasion — the spontaneous applause, the off-camera conversation that becomes the most authentic clip, the crowd reaction that turns a good event film into a great one. Our event teams are built from professionals who began their careers in news and documentary production, where getting the shot the first time — and only time — is the standard.\n\nWe offer combined event videography and photography packages as our most popular booking format, because coordinating separate teams across the same event creates gaps in coverage and operational friction on the day. A single coordinated team, briefed together and working from the same run-of-show, delivers better coverage than two independently booked crews.\n\nStandard event videography deliverables include: a same-day 60-second social media teaser, a 3–5 minute highlight film, full ceremony or keynote recording, and a B-roll library of all event activities and spaces. Photography delivers a curated edited gallery of 200–400 images within 48 hours.\n\nOur event video teams are experienced at every major Dubai and UAE venue: Dubai World Trade Centre and halls, Expo City Dubai, Armani Hotel, Atlantis, DIFC Gate, all Marriott, Hilton, and Jumeirah properties, Abu Dhabi venues including ADNEC and Yas Arena, and Expo Centre Sharjah.\n\nEvent videography from AED 2,000 for a 4-hour single-camera booking. Multi-camera production packages from AED 4,500. Combined photography and videography from AED 3,500. Same-day teaser delivery included in all packages above 6 hours. with purpose, precision, and a compelling visual story.\n\nFrom corporate conferences at the Dubai World Trade Centre to gala dinners at Burj Al Arab, award ceremonies, product launches, summits, charity events, and private celebrations — we have covered over 2,400 events since 2016. Our teams know UAE venues, handle permits, and deliver with the reliability that event organisers, PRs, and brand managers need.",
  ...
  "food": {
    ...
    description: "Backyard Studio Official is one of Dubai's leading food photography and videography companies. We produce restaurant photography, menu content, food styling shoots, delivery platform content, F&B brand campaigns, and culinary social media content for restaurants, hotels, food brands, and delivery-first businesses across the UAE.\n\nFood photography in Dubai operates in one of the world's most competitive F&B markets. Every restaurant on Zomato and Talabat is competing visually against hundreds of alternatives, and the image quality of your menu photography directly determines click-through rates, order values, and customer expectations. Professional food photography is not an optional upgrade for serious F&B businesses in Dubai — it is a baseline operational requirement.\n\nOur food photography approach starts with understanding the brand and the dish. The difference between a well-photographed burger and a great food photograph is that the great image was planned: the composition, the hero angle, the garnish placement, the liquid pours and steam timing, the background props, and the lighting ratio — all decided before the plate arrives. We work closely with your chef and the front-of-house team to ensure every hero dish gets the treatment it deserves.\n\nWe produce three types of food content: menu photography (optimised for delivery platforms and printed menus, white or simple background), editorial photography (styled lifestyle shots for Instagram, website hero images, and campaigns), and video content (short-form food films for Reels, TikTok, and delivery app video features).\n\nOur studio in Dubai can accommodate full food photography setups with multiple flat surfaces, prop inventory, and professional lighting. On-location shoots at your restaurant or commissary kitchen are also available.\n\nFood photography from AED 2,500 for a half-day session (15–20 dishes). Full menu photography from AED 5,000. F&B campaign (photo + video) from AED 8,000.",
  ...
  "fashion-shoots": {
    ...
    description: "Backyard Studio Official is one of Dubai's most respected fashion photography and videography studios. We produce editorial campaigns, seasonal lookbooks, e-commerce catalogue photography, brand campaign films, runway documentation, and social media fashion content for UAE and international fashion brands, luxury retailers, and individual designers.\n\nDubai's fashion scene is unique: a market where global luxury brands compete alongside regional designers, where the aesthetic references span from European high fashion to contemporary Arab identity to South Asian bridal wear. Successful fashion photography here requires visual literacy across all these worlds — understanding what each audience considers aspirational and what kind of imagery makes them reach for their phone or their wallet.\n\nWe operate a fully equipped fashion photography studio in Dubai with professional cyclorama, modifiable lighting rigs, and backdrop systems. Studio sessions are ideal for e-commerce catalogues, lookbook shooting, and any project that requires lighting consistency across large product counts. Location sessions — Downtown Dubai, Al Bastakiya, Dubai Creek Harbour, the desert, luxury hotel environments — provide the backgrounds that elevate editorial and campaign content above catalogue level.\n\nModel coordination is handled through our network of UAE model agencies, with access to both professional models and brand-aligned content creators for influencer-style fashion content. Styling and wardrobe coordination can be managed by our production team or integrated with the client's own stylist.\n\nPost-production delivers retouched editorial finals, catalogue images at specification (white background, specific dimensions, file format), video edits for all required formats, and colour-consistent exports across large product counts.\n\nFashion photography from AED 2,000 per half-day studio session. Location fashion shoots from AED 3,500. Fashion film production from AED 5,500. E-commerce catalogue photography from AED 150 per hero image.",
  ...
  "tv-commercials": {
    ...
    description: "Backyard Studio Official produces broadcast-quality TV commercials for UAE brands, regional advertisers, and international companies running campaigns on UAE and GCC television networks. Our TVC production meets the technical and creative standards required for OSN, Dubai TV, Abu Dhabi TV, MBC, and all regional broadcast and satellite platforms.\n\nTelevision advertising in the UAE and GCC remains one of the most impactful media channels for reaching broad Arabic-speaking audiences, upper-income expat segments, and luxury consumer demographics. The TVC is also the anchor asset for most large campaigns — the creative that informs all other channel adaptations. We treat it accordingly: with full creative development, multi-day production schedules, and post-production that matches global TVC standards.\n\nOur TVC production process: creative brief and strategy session, script development and treatment, talent casting (actors, presenters, voice-over artists), location scouting and permits (or studio production), full crew including director, DP, gaffer, and production team, post-production with offline edit, colour grade, sound design and mix, music composition or licensing, all territory deliveries, and broadcast master file preparation to specification.\n\nFor Ramadan campaigns — the single largest advertising season in the GCC — we plan productions that begin 8–12 weeks before the start of Ramadan, with creative that resonates with values of reflection, family, generosity, and community. We understand the specific visual and emotional language of successful Ramadan advertising across both Arabic and English audiences.\n\nTVC production pricing depends on scope, location, talent, and post-production requirements. Entry-level digital-broadcast TVC (30 seconds, single location, limited cast): from AED 18,000. Full broadcast campaign production: from AED 45,000. Contact us for a custom quote with full breakdown.",
  ...
  "documentary": {
    ...
    description: "Backyard Studio Official produces documentary films and long-form factual content for UAE brands, government entities, foundations, NGOs, and international organisations with projects in the region. Our documentary productions range from 5-minute brand documentaries to feature-length cinematic productions.\n\nDocumentary filmmaking is fundamentally different from commercial production. A commercial has a single message and 30–90 seconds to deliver it. A documentary has a story, characters, a journey, and an audience that needs to believe in all of them. Our documentary directors come from journalism and long-form production backgrounds — they know how to find the real story behind a brief, build trust with subjects, and construct a narrative that holds an audience's attention across 15, 30, or 60 minutes.\n\nWe produce documentaries across three main categories: brand documentaries (the story of a company, founder, or movement that builds brand equity over time), social impact documentaries (for foundations, NGOs, and government entities communicating programs and impact), and event documentaries (capturing major ceremonies, milestones, or cultural events for archival and broadcast use).\n\nPre-production is where documentary success is determined. We spend substantial time on discovery, research, subject identification, location assessment, and treatment development before the camera turns on. This phase typically runs 2–4 weeks for a 15-minute documentary and longer for feature projects. The result is a production that runs efficiently because every day on set has a clear purpose.\n\nDocumentary productions are available in multiple delivery formats: cinema screen, broadcast, streaming, digital campaigns, and social media excerpts. We deliver in English, Arabic, and with subtitles in any required language.\n\nDocumentary production pricing starts from AED 25,000 for a 10–15 minute brand documentary including 2 shoot days, full post-production, and music licensing. Feature documentary projects quoted on scope.",
  ...
  "hotel-photography": {
    ...
    description: "Backyard Studio Official produces professional hotel photography, resort campaign content, and hospitality brand visuals for hotels, resorts, serviced apartments, and luxury properties across Dubai and the UAE.\n\nHotel photography in the UAE is a high-stakes discipline. Dubai's hotel market is the most competitive in the world — hotels are competing for guests against hundreds of directly comparable properties on Booking.com, Expedia, and direct booking channels. Research consistently shows that professional photography is the single highest-impact driver of booking conversion after price. A hotel with professional photography books faster, at higher rates, and receives better reviews because guests arrive with accurate expectations.\n\nOur hotel photography packages cover the complete property: guest rooms and suites (standard room to presidential suite), bathrooms and luxury amenity details, lobby and common areas, pool and recreation facilities, spa and wellness spaces, meeting and event spaces, all restaurants and bars, exterior facades and landscaped grounds, and aerial photography (GCAA-licensed drone).\n\nF&B photography for hotel restaurants is a specialisation within hospitality photography that we approach with a dedicated food photography setup: table composition, plate styling coordination with the chef, lighting that renders food textures and colours accurately, and hero shots for menus, social media, and OTA listings.\n\nSeasonal campaign content — Ramadan, Eid, National Day, Valentine's, Christmas and New Year — requires lifestyle photography with models, styling, and art direction. Our hospitality campaign team handles this end-to-end.\n\nHotel photography packages start from AED 4,500 for a boutique property (10–15 rooms, core facilities). Full luxury hotel packages from AED 12,000. F&B campaign packages from AED 3,500 per outlet.",
  ...
  "pre-post-production": {
    ...
    description: "Backyard Studio Official provides complete pre-production and post-production services as standalone offerings for Dubai production companies, agencies, directors, and brands who need specific pipeline stages handled at a high professional level.\n\nPre-production services include: creative treatment development, screenplay and script writing, storyboard creation, mood board and visual reference decks, location scouting across all UAE emirates, location permits and authority coordination, casting coordination and talent management, shot list and schedule development, technical equipment planning, crew hiring and coordination, and budget management. We function as a complete production management layer for projects that have creative direction but need the operational infrastructure to execute.\n\nPost-production services include: offline editing and assembly, picture lock and final cut, professional colour grading (DaVinci Resolve), ADR and voice-over recording (Arabic and English), sound design and audio mix, original music composition, licensed music sourcing, motion graphics and visual effects (After Effects), subtitles and caption files in any language, and all delivery format exports for broadcast, streaming, cinema, and digital.\n\nOur colour grading suite handles projects from social media content to broadcast and cinema deliverables. Grade consistency across multi-day shoots, multiple camera systems, and mixed lighting conditions is our team's core skill — we make content shot over different days in different conditions look cohesive and intentional.\n\nTranslation and Arabic adaptation services are available: English to Arabic script adaptation, Arabic voice-over recording with professional VO artists, and Arabic subtitle files.\n\nPre-production packages from AED 3,500. Post-production editing from AED 1,500 per minute of finished film. Colour grading from AED 800 per finished minute. Full post-production packages for feature projects quoted on scope.",
...
const SERVICE_METADATA: Record<string, { title: string; description: string; keywords: string[] }> = {
  ...
  "corporate-films": {
    ...
    description: "Backyard Studio Official is Dubai's leading corporate film production company. We produce brand documentaries, investor films, company culture videos, product launch films, and corporate content for UAE businesses, government entities, and international companies operating in the region.\n\nA great corporate film does one specific job: it makes the people watching it feel something that moves them toward a decision. Whether that decision is to invest, to join, to buy, or to trust — the film exists to accelerate it. That is the standard we hold every corporate production to, and it is why our client list spans Dubai's most recognised brands alongside the government authorities shaping the emirate's future.\n\nOur corporate film process begins with a discovery session to understand what the film actually needs to achieve — not what it needs to look like. We then develop a Creative Direction document before a single frame is shot: the narrative, the tone, the interview subjects, the locations, and the specific moments that will carry the emotional weight of the piece. This step separates films that work from films that get filed away unwatched.\n\nProduction is led by our senior directors, Fahad Iqbal Butt and Syed Mazhar Zaidi, with a full professional crew including a DoP, gaffer, sound recordist, and production coordinator. We film in your offices, on your sites, and at locations that reinforce your brand's positioning. C-suite interviews are handled by directors experienced in putting executives at ease on camera — the difference between a stilted talking head and a compelling, credible spokesperson.\n\nPost-production covers the full pipeline: offline assembly, colour grade, sound design, professional music licensing, motion graphics, Arabic and English subtitles, and voice-over in either language. Two rounds of revision are included in every corporate film package, and we deliver in all required formats — website hero video, LinkedIn native, YouTube long-form, investor deck embed, and event screen.\n\nTurnaround for a standard corporate brand film is 14–21 days from the shoot date. Rush timelines are available for investor deadlines and event premieres. Pricing starts from AED 15,000 for a 2–3 minute brand film and scales with complexity, locations, and post-production requirements. Contact us via WhatsApp or the brief form for a same-day quote.",
...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  if (custom) {
    return {
      ...
      openGraph: {
        ...
        locale: "en_AE",
        type: "website",
        images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: custom.title }],
      },
      twitter: {
  ...
  return {
    ...
    openGraph: {
      ...
      locale: "en_AE",
      type: "website",
      images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: `${s.title} — Backyard Studio Official Dubai` }],
    },
    twitter: {
      card: "summary_large_image",
      title: `${s.title} in Dubai UAE`,
      description: `Professional ${fmtSlug} in Dubai and all UAE emirates.`,
      images: ["/og-image.jpg"],
    },
  };
}
