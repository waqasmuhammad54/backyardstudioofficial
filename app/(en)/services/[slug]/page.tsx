...
const SERVICE_DATA: Record<string, { title: string; description: string; includes: string[]; faqs: { q: string; a: string }[] }> = {
  ...
  "aerial-drone": {
    ...
    faqs: [
      { q: "Is your drone operation GCAA-approved?", a: "Yes. Backyard Studio Official is a GCAA-licensed drone operator, meaning we are fully authorised to fly commercially across the UAE. All flights are conducted by individually GCAA-licensed pilots and our operations carry full public liability insurance." },
...
const SERVICE_METADATA: Record<string, { title: string; description: string; keywords: string[] }> = {
  ...
  "aerial-drone": {
    ...
    keywords: ["aerial drone videography Dubai", "drone videographer Dubai", "GCAA-approved drone operator UAE", "drone filming Dubai", "drone photography UAE", "aerial videography Dubai wedding"],
  },
  "corporate-films": {
