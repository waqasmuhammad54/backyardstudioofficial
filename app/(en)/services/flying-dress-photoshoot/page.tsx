...
const PACKAGES = [
  ...
  },
  {
    ...
    includes: ["2-hour shoot, 2 locations", "2 dress colours", "Drone aerials (where permitted)", "100+ edited photos", "Golden-hour scheduling", "10 premium retouched selects", "48-hour delivery"],
    featured: true,
  },
  {
    name: "Luxury",
