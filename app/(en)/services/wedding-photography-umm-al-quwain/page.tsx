...
export const metadata: Metadata = {
  ...
  description:
    "Wedding photographer in Umm Al Quwain — intimate beach ceremonies, mangrove lagoon couple shoots & family villa weddings. Photo + video from AED 7,500, GCAA drone, no travel fees, 48-hour delivery.",
  keywords: [
  ...
  openGraph: {
    title: "Wedding Photographer Umm Al Quwain | From AED 7,500 — Backyard Studio Official",
  ...
  twitter: { card: "summary_large_image", title: "Wedding Photographer Umm Al Quwain | From AED 7,500", description: "Intimate beach & villa weddings. 48-hour delivery, no travel fees.", images: ["/images/wedding/wedding-18.webp"] },
};

const FAQS = [
  {
    q: "How much does a wedding photographer cost in Umm Al Quwain?",
    a: "The same as every emirate we serve: Essential photography AED 7,500, Silver photo + video AED 15,500, full-day Gold AED 22,500 with drone and same-day teaser, Platinum from AED 65,000. UAQ is under an hour from our Dubai base and travel is always free.",
  },
  {
  ...
  },
  {
    ...
    a: "It is the UAE's best-kept secret for exactly that — empty beaches, no crowds, easy permissions for small private ceremonies, and sunset light over the lagoon. Our Essential (AED 7,500) and Silver (AED 15,500) packages fit UAQ elopements and sub-50-guest weddings perfectly.",
  },
  {
...
const VENUES = [
  ...
  { name: "Elopements Anywhere", desc: "Two people, one photographer, golden hour — from AED 7,500." },
];
...
export default function WeddingPhotographyUAQPage() {
  ...
  const service = servicePageSchema({
    ...
    description: "Intimate beach and villa wedding photography in Umm Al Quwain — from AED 7,500 with no travel fees.",
    url: PAGE_URL,
    price: "1799",
  });
        ...
        <div className="container-xl grid lg:grid-cols-3 gap-16">
          ...
          <div className="space-y-5 lg:pt-2">
            ...
            <div className="p-6 border" style={{ borderColor: "var(--border)", background: "var(--black-2)" }}>
              ...
              <p className="text-xs mt-1" style={{ color: "var(--muted)" }}>Private beaches, from AED 7,500</p>
            </div>
            <div className="p-6 border" style={{ borderColor: "var(--border)", background: "var(--black-2)" }}>
