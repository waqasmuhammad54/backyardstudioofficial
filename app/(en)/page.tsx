...
const HOME_FAQS = [
  ...
  },
  {
    ...
    answer: "Aerial coverage is available as part of our productions — for real estate, resorts, events, launches and campaigns — with the required permits arranged in advance, rather than as a standalone drone booking. Aerial work is fully permitted, with all airspace approvals across the 7 UAE emirates, alongside events, weddings, corporate films, DVCs, social media content and commercial photography.",
  },
  {
