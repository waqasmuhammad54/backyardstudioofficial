...
const SUB_INDUSTRY_DATA: Record<string, Record<string, {
  ...
  "automotive": {
    ...
    "car-launch": {
      ...
      metaDescription: "Car launch campaign production in Dubai. Commercial films, dealership events, social reels, press content and drone aerials. GCAA-approved drone service available. Free quote.",
  ...
  "hospitality": {
    ...
    "resorts": {
      ...
      faqs: [
        ...
        { q: "Do you handle GCAA drone permits for resort aerials?", a: "Yes. All all drone operation is GCAA-approved and we manage the no-objection certificate process for resort locations. Coastal properties sometimes require additional coastal authority clearance, which we also coordinate." },
  ...
  "real-estate": {
    ...
    "luxury-villa": {
      ...
      faqs: [
        ...
        { q: "Do you include drone photography in the villa package?", a: "Yes. Drone is included in our luxury villa package as standard. All flights are GCAA-approved and we obtain the necessary no-objection certificates. Palm Jumeirah and Downtown Dubai require DCAA approval, which we coordinate." },
    ...
    "commercial-property": {
      ...
      faqs: [
        ...
        { q: "Can you include aerial footage of commercial buildings?", a: "Yes, where permitted — aerial coverage is available within our productions under GCAA-licensed drone operation and the required approvals. For industrial and logistics assets it is often the most valuable shot in the package, because access, road links and yard area are what tenants are assessing." },
