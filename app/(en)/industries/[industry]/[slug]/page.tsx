...
const SUB_INDUSTRY_DATA: Record<string, Record<string, {
  ...
  "sports": {
    ...
    "padel": {
      ...
      solution: "We have developed a padel-specific production setup — court positioning optimised for glass wall management, frame rate selection for rally playback, and an editing workflow that identifies the best exchanges quickly rather than reviewing hours of footage. Our drone setup for outdoor padel venues is fully permitted and adds aerial context that shows the full court, club environment, and event scale in a single shot.",
      services: [
      ...
      results: [
        ...
        { stat: "Aerial", label: "Drone coverage for outdoor padel venues" },
    ...
    "cycling": {
      ...
      results: [
        ...
        { stat: "Aerial", label: "Drone coverage for peloton aerials" },
    ...
    "running": {
      ...
      results: [
        ...
        { stat: "Aerial", label: "Drone coverage for mass start aerials" },
      ...
      faqs: [
        ...
        { q: "Can you cover trail running events in the UAE mountains?", a: "Yes. We cover trail running events in the Hajar Mountains, Hatta, and the Northern Emirates mountain environments. Trail events require specific logistics — follow vehicle access is limited on mountain trails, so we position crew at key technical sections, summits, and finish areas, with drone coverage for mountain aerials where permitted." },
    ...
    "football": {
      ...
      caseStudy: {
        ...
        body: "A UAE Pro League club engaged us for season-long match coverage after their in-house team struggled with production quality and delivery speed. We deployed a 4-camera live rig, pitch-side photographer, and drone coverage for aerial stadium shots across 18 home fixtures. The same-day highlight reel format averaged 1.8M views per match by the end of the season. By mid-season, the club's social following had grown 34% and all sponsor inventory for the following season had been sold three months before the start.",
      },
      faqs: [
  ...
  "automotive": {
    ...
    "car-launch": {
      ...
      metaDescription: "Car launch campaign production in Dubai. Commercial films, dealership events, social reels, press content and drone aerials. Free quote.",
      ...
      results: [
        ...
        { stat: "Aerial", label: "Drone coverage for all launch locations" },
  ...
  "hospitality": {
    ...
    "hotels": {
      ...
      results: [
        ...
        { stat: "Aerial", label: "Drone coverage for property photography" },
    ...
    "resorts": {
      ...
      services: [
        ...
        { label: "F&B Venue Content", href: "/services/food", desc: "Restaurant, bar, and pool bar photography and video — morning through evening light." },
      ...
      faqs: [
        ...
        { q: "Do you handle drone permits for resort aerials?", a: "Yes. All all drone operation is fully permitted and we manage the no-objection certificate process for resort locations. Coastal properties sometimes require additional coastal authority clearance, which we also coordinate." },
  ...
  "real-estate": {
    ...
    "luxury-villa": {
      ...
      faqs: [
        ...
        { q: "Do you include drone photography in the villa package?", a: "Yes. Drone is included in our luxury villa package as standard. All flights are fully permitted and we obtain the necessary no-objection certificates. Palm Jumeirah and Downtown Dubai require DCAA approval, which we coordinate." },
    ...
    "commercial-property": {
      ...
      faqs: [
        ...
        { q: "Can you include aerial footage of commercial buildings?", a: "Yes, where permitted — aerial coverage is available within our productions with the required approvals arranged in advance. For industrial and logistics assets it is often the most valuable shot in the package, because access, road links and yard area are what tenants are assessing." },
  ...
  "food-beverage": {
    ...
    "restaurants": {
      ...
      services: [
        { label: "Menu Photography", href: "/services/food", desc: "Hero dish photography and full menu coverage for delivery apps, your website, and printed menus." },
        ...
        { label: "Delivery App Optimisation", href: "/services/food", desc: "Photography and listing image sets formatted to Talabat, Deliveroo, and Noon Food specifications." },
    ...
    "menu-photography": {
      ...
      services: [
        { label: "Delivery App Photography", href: "/services/food", desc: "White background and clean lifestyle dish photography formatted to Talabat, Deliveroo, and Noon Food specifications." },
        { label: "Printed Menu Photography", href: "/services/food", desc: "High-resolution dish photography suitable for printed menu design, with colour profiles matched to print production requirements." },
        { label: "Website Gallery Photography", href: "/services/food", desc: "Hero dish photography and category gallery sets for restaurant website integration." },
        ...
        { label: "Drinks Photography", href: "/services/food", desc: "Cocktail, coffee, juice, and mocktail photography — styled for menu and social use." },
        { label: "Volume Menu Packages", href: "/services/food", desc: "Full-menu coverage packages for groups and multi-location operators — consistent quality across all brands." },
      ],
      results: [
