...
const INDUSTRY_DATA: Record<string, {
  ...
  "hospitality": {
    ...
    metaDescription: "Hotel photography, resort video, F&B shoots and drone coverage for 5-star UAE properties. 100+ hotels shot across all 7 emirates. Free quote in 2 hours.",
    ...
    faqs: [
      ...
      { q: "Do you include drone photography in hotel packages?", a: "Yes. All our hotel photography packages include drone aerials scheduled at golden hour for maximum visual impact. We file flight clearances in advance and coordinate with your operations team to minimise guest impact during the aerial session." },
  ...
  "real-estate": {
    ...
    caseStudy: { title: "Off-Plan Launch Campaign", client: "Tier-1 UAE Developer, Dubai", result: "AED 2.1bn in sales enquiries generated in launch week", body: "A major UAE developer engaged us to produce the full content suite for an off-plan residential tower launch — including lifestyle video, drone aerials of the community masterplan, and a 3-minute launch film screened at the sales event. The campaign drove AED 2.1bn in enquiries in launch week." },
    faqs: [
      ...
      { q: "Can you shoot properties across all UAE emirates?", a: "Yes. We cover all 7 UAE emirates with our own crew and in-house aerial coverage. We shoot regularly in Ras Al Khaimah, Fujairah, Ajman, and UAQ as well as the primary Dubai and Abu Dhabi markets. No travel premium for UAE locations." },
  ...
  "sports": {
    ...
    faqs: [
      ...
      { q: "Do you cover padel tournaments in Dubai?", a: "Yes. Padel is one of the fastest-growing sports in UAE and we cover padel tournaments regularly across Dubai, Abu Dhabi, and Ras Al Khaimah. Drone flights are fully permitted for outdoor padel venues and deliver same-day social cuts, sponsor reels, and full tournament films. See our padel production page for full detail on what we deliver." },
  ...
  "automotive": {
    ...
    metaDescription: "Automotive video and car photography in Dubai. Commercials, dealership shoots, dynamic on-road filming and drone aerials. Free quote.",
    ...
    results: [
      ...
      { stat: "Aerial", label: "Drone coverage for all car shots" },
