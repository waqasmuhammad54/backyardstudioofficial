...
const INDUSTRY_DATA: Record<string, {
  ...
  "hospitality": {
    ...
    metaTitle: "Hotel Photography Dubai UAE | Backyard Studio",
  ...
  "real-estate": {
    ...
    metaTitle: "Real Estate Photography Dubai UAE | Backyard Studio",
    ...
    faqs: [
      ...
      { q: "Can you shoot properties across all UAE emirates?", a: "Yes. We cover all 7 UAE emirates with our own crew and GCAA-licensed drone team. We shoot regularly in Ras Al Khaimah, Fujairah, Ajman, and UAQ as well as the primary Dubai and Abu Dhabi markets. No travel premium for UAE locations." },
  ...
  "fashion": {
    ...
    metaTitle: "Fashion Photography Dubai | Backyard Studio",
  ...
  "food-beverage": {
    ...
    metaTitle: "Food Photography Dubai UAE | Backyard Studio",
  ...
  "sports": {
    ...
    metaTitle: "Sports Video Production Dubai UAE | Backyard Studio",
    ...
    faqs: [
      ...
      { q: "Do you cover padel tournaments in Dubai?", a: "Yes. Padel is one of the fastest-growing sports in UAE and we cover padel tournaments regularly across Dubai, Abu Dhabi, and Ras Al Khaimah. We hold GCAA drone clearance for outdoor padel venues and deliver same-day social cuts, sponsor reels, and full tournament films. See our padel production page for full detail on what we deliver." },
  ...
  "automotive": {
    ...
    metaTitle: "Automotive & Car Photography Dubai | Backyard Studio",
    metaDescription: "Automotive video and car photography in Dubai. Commercials, dealership shoots, dynamic on-road filming and drone aerials. GCAA licensed. Free quote.",
  ...
  "tech": {
    ...
    metaTitle: "Tech Video Production Dubai UAE | Backyard Studio",
