...
<p>The drone work was scheduled across two mornings to capture the marina location in different conditions — early calm light for the architectural aerials and mid-morning golden-hour colour for the lifestyle cuts. Dubai Marina presents an unusually dense flying environment, so flight paths and timing were coordinated with the relevant authorities to ensure all aerials were captured legally and safely.</p>
