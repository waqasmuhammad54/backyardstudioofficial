...
const COPY = {
  ar: {
    ...
    choose: "اختر الخدمة",
    services: ["تصوير الأعراس", "تصوير الفعاليات", "محتوى السوشيال ميديا", "ريلز", "إعلانات DVC", "أفلام مؤسسية", "تصوير جوي", "تصوير المنتجات", "تصوير العقارات", "خدمات أخرى"],
  ...
  ru: {
    ...
    services: ["Свадебная съёмка", "Съёмка мероприятий", "Контент для соцсетей", "Reels / TikTok", "DVC реклама", "Корпоративные фильмы", "Аэросъёмка", "Съёмка продуктов", "Съёмка недвижимости", "Другое"],
  ...
  zh: {
    ...
    choose: "选择服务",
    services: ["婚礼摄影", "活动摄影", "社交媒体内容", "Reels / TikTok", "DVC广告", "企业影片", "无人机航拍", "产品摄影", "房产摄影", "其他服务"],
