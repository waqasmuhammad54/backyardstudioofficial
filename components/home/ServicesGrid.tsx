...
import { Camera, Film, Video, Smartphone, Megaphone, MessageSquare, ImageIcon, Radio, Building2, Clapperboard, Car, Home, Mic, Youtube, Utensils, Package, Users, ArrowUpRight } from "lucide-react";
...
const SERVICES = [
  ...
  { icon: Car,           slug: "automotive",              label: "Automotive Videography & Photography",  num: "04", desc: "Studio and on-road car shoots, dynamic footage, and drone aerials for UAE auto brands." },
  ...
  { icon: Radio,         slug: "live-streaming",          label: "Live Streaming & Match Coverage",       num: "14", desc: "Multi-camera live streaming and full match coverage across the UAE, from AED 20,000." },
